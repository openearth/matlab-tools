...
for ii=1:length(D.latitude)
    ...
    tableContents = [];
                   tableContents = [tableContents sprintf([...
                      ...
                      [num2str(D.([OPT.standard_name,'_min' ])(ii),'%g'),' ',units.([OPT.standard_name,'_min' ])],...
                      [num2str(D.([OPT.standard_name,'_mean'])(ii),'%g'),' ',units.([OPT.standard_name,'_mean'])],...
                      [num2str(D.([OPT.standard_name,'_max' ])(ii),'%g'),' ',units.([OPT.standard_name,'_max' ])],...
                      [num2str(D.([OPT.standard_name,'_std' ])(ii),'%g'),' ',units.([OPT.standard_name,'_std' ])],...

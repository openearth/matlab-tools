   ...
   for ii=1:length(D.geospatialCoverage_eastwest_start)
    ...
    %% make table
       ...
       tableContents = [tableContents sprintf([...
        ...
        '<tr><td bgcolor="#FFFFFF"># times:      </td><td bgcolor="#FFFFFF">%g</td></tr>'...
        '<tr><td bgcolor="#FFFFFF">1st time:     </td><td bgcolor="#FFFFFF">%s</td></tr>'...
        '<tr><td bgcolor="#FFFFFF">last time:    </td><td bgcolor="#FFFFFF">%s</td></tr>',...
        ...
        '<tr><td bgcolor="#FFFFFF">std:          </td><td bgcolor="#FFFFFF">%s</td></tr><hr>',...
        '%s',...
        '<tr><td bgcolor="#FFFFFF">meta-data:    </td><td bgcolor="#FFFFFF"><a href="%s">OPeNDAP (THREDDS)</a>'...
    ...
    table = [...
        ...
        '<tr><td colspan="2" bgcolor="#666666"><div style="color:#FFFFFF;">',char(OPT.text),'</div></td></tr>'...
        tableContents...
        '</table><hr>' preview];

...
%
% Save struct to THREDDS catalog.xml with NC_CF_HARVEST2XML.
%
% NB This function will replace NC_CF_OPENDAP2CATALOG in the near future.
%
%See also: NC_INFO, nc_dump, NC_ACTUAL_RANGE, NC_CF_HARVEST1, OPENDAP_CATALOG, 
%          thredds_dump, thredds_info, nc_cf_harvest2xml
   ...
   for i=1:n
      ...
      if ~(OPT.flat)
         D(i) = nc_cf_harvest1(ncfiles{i});
      else
         d    = nc_cf_harvest1(ncfiles{i});

function [cout,hout] = tricontour(xy,connection,Z,N,color,filled)
% Contouring for functions defined on triangular meshes
%
%   tricontour(xy,connection,Z,N,color,filled)
%
...
% connectivity:
%
%   xy = [x1,y1; x2,y2; etc],            - xy co-ordinates of nodes in the
%                                         triangulation
%   connection = [n11,n12,n13; n21,n23,n23; etc] - node numbers in each triangle
%
    ...
    if nargout>0
        ...
        for k = 1:ncc
            ...
            if (ce==0)||(ce==start)||(flag(ce))     
                ...
                elseif filled
                    h   = [h; patch('Xdata',x,'Ydata',y,'Zdata',z, ...
                        'Cdata',z,'facecolor',color,'edgecolor',color)]; hold on
                else
                    h   = [h; patch('Xdata',[x,NaN],'Ydata',[y,NaN],'Zdata',z, ...
                        'Cdata',z,'facecolor','none','edgecolor',color)]; hold on
                end

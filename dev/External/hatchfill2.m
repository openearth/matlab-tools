...
%
%       Only hatching:
%       vXtempP = [0.1 0.2 0.2 0.1 0.1];
%       vYtempP = [0.6 0.6 0.7 0.7 0.6];
%       tt = patch(vXtempP,vYtempP,'m','EdgeColor','m','LineWidth',1,'FaceAlpha',0.0);
%       hatchfill2(tt,'single','HatchAngle',45,'HatchSpacing',7,'HatchColor','m','HatchLineWidth',1);
%

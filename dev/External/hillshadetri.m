function h = hillshadetri(z,x,y,ikle,varargin)
% PUPROSE: Calculate hillshade for a digital elevation model (DEM)
% -------------------------------------------------------------------
% USAGE: h = hillshadetri(z,x,y,ikle,varargin)
...
% modified by ABR for triangles 16-1-2020
% https://nl.mathworks.com/matlabcentral/fileexchange/14863-hillshade
%% configure inputs
%default parameters
azimuth=315;
altitude=45;
...
[fx,fy] = Triangle.gradPoin(ikle,[x,y],z);

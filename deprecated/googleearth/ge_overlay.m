...
overlayXY_chars = ['<overlayXY x="' num2str(x) '" y="' num2str(y) '" xunits="' xunits '" yunits="' yunits '"/>'];
screenXY_chars  = ['<screenXY x="' num2str(x) '" y="' num2str(y) '" xunits="' xunits '" yunits="' yunits '"/>'];
rotation_chars  = ['<rotation>' num2str(rotation) '</rotation>'];
size_chars      = ['<size x="',num2str(xSize),'" y="',num2str(ySize),'" xunits="' xSizeUnits '" yunits="' ySizeUnits '"/>'];

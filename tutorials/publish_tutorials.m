tutorial_scripts = dir(fullfile(openearthtoolsroot,'matlab','tutorials','tutorial_*.m'));
...
status = [2 0 3 3 3 2 0 3 1  2  3  1  0  2  0];
...
for ii = 1:length(tutorial_scripts)
    switch status(ii)
        ...
        case 1; disp(sprintf('%3d <a href="matlab: edit %s">%-43s</a> - work in progress'                            ,ii,tutorial_scripts(ii).name(1:end-2),tutorial_scripts(ii).name))

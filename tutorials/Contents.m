...
%       <a href="matlab:web(['jar:file:///' strrep(openearthtoolsroot,filesep,'/') 'docs/OpenEarthDocs/oethelpdocs/help.jar!/html/tutorial_netCDF_read_functions.html'], '-helpbrowser');">Reading a netCDF file</a>
%
%     print fun:
...
%
%     DUROS:
%       <a href="matlab:web(['jar:file:///' strrep(openearthtoolsroot,filesep,'/') 'docs/OpenEarthDocs/oethelpdocs/help.jar!/html/findCrossings_tutorial.html'], '-helpbrowser');">Find crossings between arbitrary line segments</a>
%
%     Rijkswaterstaat:
%       <a href="matlab:web(['jar:file:///' strrep(openearthtoolsroot,filesep,'/') 'docs/OpenEarthDocs/oethelpdocs/help.jar!/html/jarkus_tutorial_coordinates_RSP_2_RD.html'], '-helpbrowser');">Coordinate conversion from RSP to RD</a>
%       <a href="matlab:web(['jar:file:///' strrep(openearthtoolsroot,filesep,'/') 'docs/OpenEarthDocs/oethelpdocs/help.jar!/html/jarkus_tutorial_reading_data_1.html'], '-helpbrowser');">Extracting JarKus data from netCDF (1)</a>
%       <a href="matlab:web(['jar:file:///' strrep(openearthtoolsroot,filesep,'/') 'docs/OpenEarthDocs/oethelpdocs/help.jar!/html/jarkus_tutorial_reading_data_2.html'], '-helpbrowser');">Extracting JarKus data from netCDF (2)</a>
%       <a href="matlab:web(['jar:file:///' strrep(openearthtoolsroot,filesep,'/') 'docs/OpenEarthDocs/oethelpdocs/help.jar!/html/jarkus_tutorial_calculate_MKL.html'], '-helpbrowser');">JarKus MKL calculations</a>
%       <a href="matlab:web(['jar:file:///' strrep(openearthtoolsroot,filesep,'/') 'docs/OpenEarthDocs/oethelpdocs/help.jar!/html/jarkus_tutorial_calculate_volume.html'], '-helpbrowser');">JarKus volume calculations</a>
%       <a href="matlab:web(['jar:file:///' strrep(openearthtoolsroot,filesep,'/') 'docs/OpenEarthDocs/oethelpdocs/help.jar!/html/jarkus_tutorial_plot_in_googleEarth.html'], '-helpbrowser');">Jarkus & Google Earth</a>
%
%     SuperTrans:
...
%
%     probabilistic:
%       <a href="matlab:web(['jar:file:///' strrep(openearthtoolsroot,filesep,'/') 'docs/OpenEarthDocs/oethelpdocs/help.jar!/html/prob_calculation_tutorial.html'], '-helpbrowser');">setting up a probabilistic calculation</a>
%

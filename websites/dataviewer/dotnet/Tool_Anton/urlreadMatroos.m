function [string,status] = urlreadMatroos(urlChar,method,params);
...
%
%    [S,STATUS] = ... catches any errors and returns 1 if the file downloaded
...
urlConnection.setRequestProperty('Authorization','Basic ZGVsdGFyZXM6TUBUUjAwJA==');

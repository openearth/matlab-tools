...
namespace BwnFunctions
{
  ...
  public class BwnFunctions : IDisposable
  {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray PlotTimeSeries(MWArray ncfile, MWArray ncVariable, MWArray startTime)
    {
    ...
    /// <summary>
    /// Provides a single output, 4-input MWArrayinterface to the PlotTimeSeries
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <summary>
    /// Provides a single output, 5-input MWArrayinterface to the PlotTimeSeries
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    ///
    public MWArray PlotTimeSeries(MWArray ncfile, MWArray ncVariable, MWArray startTime, 
                            MWArray stopTime, params MWArray[] varargin)
    {
      MWArray[] args = {ncfile, ncVariable, startTime, stopTime};
      int nonVarargInputNum = args.Length;
      int varargInputNum = varargin.Length;
      int totalNumArgs = varargInputNum > 0 ? (nonVarargInputNum + varargInputNum) : nonVarargInputNum;
      Array newArr = Array.CreateInstance(typeof(MWArray), totalNumArgs);
    ...
    /// <summary>
    /// Provides the standard 4-input MWArray interface to the PlotTimeSeries M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// function [output] = PlotTimeSeries(ncfile,ncVariable, startTime, stopTime,
    ...
    ///
    public MWArray[] PlotTimeSeries(int numArgsOut, MWArray ncfile, MWArray ncVariable, 
                              MWArray startTime, MWArray stopTime)
    {
    ...
    /// <summary>
    /// Provides the standard 5-input MWArray interface to the PlotTimeSeries M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// function [output] = PlotTimeSeries(ncfile,ncVariable, startTime, stopTime,
    ...
    ///
    public MWArray[] PlotTimeSeries(int numArgsOut, MWArray ncfile, MWArray ncVariable, 
                              MWArray startTime, MWArray stopTime, params MWArray[] 
                              varargin)
    {
      MWArray[] args = {ncfile, ncVariable, startTime, stopTime};
      int nonVarargInputNum = args.Length;

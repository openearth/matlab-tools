...
rem now run matlab
matlab -nosplash -nodesktop -minimize -r "TeamCity_makedocumentation(%BUILD_VCS_NUMBER_svn__https___repos_deltares_nl_repos_OpenEarthTools_trunk_matlab%);" -logfile mlogfile.log

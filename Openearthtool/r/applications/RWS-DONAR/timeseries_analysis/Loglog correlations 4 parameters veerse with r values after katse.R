...
ChlorASoelekerkepolder<- subset(dfChlorA, ChlorAVeerse$Location == "Soelekerkepolder oost")
...
subset <- subset(data, as.Date(total.Date) >= "2004-07-01" & as.Date(total.Date)<="2014-01-01")
...
# plot the data
#save plot in pdf
pdf("Loglogdifferentparametersveerse4afterkatse.pdf", width=12, height=8)

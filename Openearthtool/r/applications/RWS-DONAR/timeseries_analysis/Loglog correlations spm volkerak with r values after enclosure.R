...
subset <- subset(data, as.Date(SPMVolkerak.Date) >= "1987-01-01" & as.Date(SPMVolkerak.Date)<="1994-01-01")
...
# plot the data
#save plot in pdf
pdf("Loglogcorrelationspmvolkerakafterenclosure.pdf", width=12, height=8)

...
sub chem_preprocess 
{
	...
	if (! -e "$chem_proc_bld/$chem_proc_exe") {
	    my $gmake = 'gmake';
	    build_chem_preproc($gmake,$chem_preprocessor ,$chem_proc_bld,$chem_proc_exe);
	}
...
{
    my ($gmake,$chem_proc_src,$chem_proc_bld,$chem_proc_exe) = @_;

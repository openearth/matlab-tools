!===============================================================================
! SVN $Id: smooth_mod.F90 40622 2012-09-28 17:07:34Z mlevy@ucar.edu $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/tools/mapping/trunk_tags/mapping_121113b/gen_mapping_files/runoff_to_ocn/src/smooth_mod.F90 $
!===============================================================================
...
!   real,parameter   :: DtoR     =  3.14159265358979323846/180.0  
   real,parameter   :: DtoR = DEGtoRAD
   real,allocatable :: garr(:,:,:)   ! dummy runoff (nx,ny,nbasin) in kg/s/m^2
...
!  map_out%frac_b = map_in%frac_b
   ...
   map_out%method     = "created using SVN $Id: smooth_mod.F90 40622 2012-09-28 17:07:34Z mlevy@ucar.edu $"
...
SUBROUTINE smooth(map,efold,rmax)
   ...
   real, allocatable :: rdist(:,:),areaa(:,:),wgt(:,:),wgt2(:,:)
...
!-----------------------------------------------------------------------
   ...
   real, intent(inout),dimension(ni,nj) :: rdist
   real :: rmax,d
   real :: ds,dn,de,dw
   real :: dne, dnw, dse, dsw

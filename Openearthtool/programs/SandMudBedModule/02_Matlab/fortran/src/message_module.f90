...
!  $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/programs/SandMudBedModule/02_Matlab/fortran/src/message_module.f90 $
!!--description-----------------------------------------------------------------
!
...
subroutine message_module_info(messages)
    ...
    call addmessage(messages,'$URL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/programs/SandMudBedModule/02_Matlab/fortran/src/message_module.f90 $')

...
# $Id: odv2orm_model.py 12734 2016-05-13 08:33:31Z gerben.deboer.x $
# $Date: 2016-05-13 01:33:31 -0700 (Fri, 13 May 2016) $
# $Author: gerben.deboer.x $
# $Revision: 12734 $
# $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/python/OpenEarthTools/openearthtools/io/pyodv/odv2orm_model.py $
# $Keywords: $
...
class Observation(Base):
    ...
    datetime      = Column(DateTime(timezone=False))     # SDN requires UTC
    geom          = Column(Geometry('POINT', srid=4326)) # SDN requires WGS84
    depth         = Column(Float)     # Bottom depth of (x,y) location geom, not z-position

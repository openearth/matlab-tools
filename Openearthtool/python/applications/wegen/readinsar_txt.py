...
lstcsv.append(glob.glob(r'D:\projecten\datamanagement\Nederland\wegen\ftp\insar\a27\data\*.csv'))
lstcsv.append(glob.glob(r'D:\projecten\datamanagement\Nederland\wegen\ftp\insar\a12\data\*.csv'))

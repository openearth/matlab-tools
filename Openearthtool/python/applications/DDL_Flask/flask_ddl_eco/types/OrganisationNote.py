...
"""
Auto-generated class for OrganisationNote
"""
...
class OrganisationNote(object):
    ...
    def create(**kwargs):
        ...
        :rtype: OrganisationNote
        """

        return OrganisationNote(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'OrganisationNote'
        data = json or kwargs
        ...
        data_types = [string_types]
        self.note = client_support.set_property('note', data, data_types, False, [], False, True, class_name)
        data_types = [string_types]

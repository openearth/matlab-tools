...
"""
Auto-generated class for ExpandedCompartment
"""
...
class ExpandedCompartment(object):
    """
    ...
    def create(**kwargs):
        ...
        :rtype: ExpandedCompartment
        """

        return ExpandedCompartment(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'ExpandedCompartment'
        data = json or kwargs

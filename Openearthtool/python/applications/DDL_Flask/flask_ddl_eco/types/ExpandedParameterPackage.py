...
"""
Auto-generated class for ExpandedParameterPackage
"""
...
class ExpandedParameterPackage(object):
    """
    ...
    def create(**kwargs):
        ...
        :rtype: ExpandedParameterPackage
        """

        return ExpandedParameterPackage(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'ExpandedParameterPackage'
        data = json or kwargs

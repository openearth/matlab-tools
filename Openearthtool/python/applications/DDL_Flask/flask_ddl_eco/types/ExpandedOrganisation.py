...
"""
Auto-generated class for ExpandedOrganisation
"""
...
class ExpandedOrganisation(object):
    """
    ...
    def create(**kwargs):
        ...
        :type numericcode: float
        :rtype: ExpandedOrganisation
        """

        return ExpandedOrganisation(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'ExpandedOrganisation'
        data = json or kwargs
        ...
        data_types = [float]
        self.numericcode = client_support.set_property(
            'numericcode', data, data_types, False, [], False, True, class_name)

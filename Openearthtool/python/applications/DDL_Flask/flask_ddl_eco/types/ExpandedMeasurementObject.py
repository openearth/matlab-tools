...
"""
Auto-generated class for ExpandedMeasurementObject
"""
...
class ExpandedMeasurementObject(object):
    """
    ...
    def create(**kwargs):
        ...
        :type monitoringNetworks: list[string_types]
        :type organisation: string_types
        :rtype: ExpandedMeasurementObject
        """

        return ExpandedMeasurementObject(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'ExpandedMeasurementObject'
        data = json or kwargs
        ...
        data_types = [string_types]
        self.monitoringNetworks = client_support.set_property(
            'monitoringNetworks', data, data_types, False, [], True, True, class_name)
        data_types = [string_types]

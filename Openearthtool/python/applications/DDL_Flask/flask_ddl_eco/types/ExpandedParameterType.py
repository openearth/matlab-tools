...
"""
Auto-generated class for ExpandedParameterType
"""
...
class ExpandedParameterType(object):
    """
    ...
    def create(**kwargs):
        ...
        :rtype: ExpandedParameterType
        """

        return ExpandedParameterType(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'ExpandedParameterType'
        data = json or kwargs

...
"""
Auto-generated class for MonitoringNetwork
"""
...
class MonitoringNetwork(object):
    """
    ...
    def create(**kwargs):
        ...
        :rtype: MonitoringNetwork
        """

        return MonitoringNetwork(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'MonitoringNetwork'
        data = json or kwargs

...
"""
Auto-generated class for MeasurementPurpose
"""
...
class MeasurementPurpose(object):
    """
    ...
    def create(**kwargs):
        ...
        :rtype: MeasurementPurpose
        """

        return MeasurementPurpose(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'MeasurementPurpose'
        data = json or kwargs

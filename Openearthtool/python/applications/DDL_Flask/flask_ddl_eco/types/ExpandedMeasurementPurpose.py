...
"""
Auto-generated class for ExpandedMeasurementPurpose
"""
...
class ExpandedMeasurementPurpose(object):
    """
    ...
    def create(**kwargs):
        ...
        :rtype: ExpandedMeasurementPurpose
        """

        return ExpandedMeasurementPurpose(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'ExpandedMeasurementPurpose'
        data = json or kwargs

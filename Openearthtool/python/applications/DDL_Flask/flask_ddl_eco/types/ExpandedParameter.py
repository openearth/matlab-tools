...
"""
Auto-generated class for ExpandedParameter
"""
...
class ExpandedParameter(object):
    """
    ...
    def create(**kwargs):
        ...
        :rtype: ExpandedParameter
        """

        return ExpandedParameter(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'ExpandedParameter'
        data = json or kwargs

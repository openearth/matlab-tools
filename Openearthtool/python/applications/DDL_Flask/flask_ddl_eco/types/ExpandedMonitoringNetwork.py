...
"""
Auto-generated class for ExpandedMonitoringNetwork
"""
...
class ExpandedMonitoringNetwork(object):
    """
    ...
    def create(**kwargs):
        ...
        :type locations: list[string_types]
        :type name: string_types
        :type organisation: string_types
        :rtype: ExpandedMonitoringNetwork
        """

        return ExpandedMonitoringNetwork(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'ExpandedMonitoringNetwork'
        data = json or kwargs
        ...
        data_types = [string_types]
        self.locations = client_support.set_property('locations', data, data_types, False, [], True, True, class_name)
        data_types = [string_types]

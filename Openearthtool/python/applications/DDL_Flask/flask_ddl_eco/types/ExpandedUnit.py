...
"""
Auto-generated class for ExpandedUnit
"""
...
class ExpandedUnit(object):
    ...
    def create(**kwargs):
        ...
        :type symbol: string_types
        :rtype: ExpandedUnit
        """

        return ExpandedUnit(**kwargs)

    def __init__(self, json=None, **kwargs):
        if json is None and not kwargs:
            raise ValueError('No data or kwargs present')

        class_name = 'ExpandedUnit'
        data = json or kwargs
        ...
        data_types = [string_types]
        self.symbol = client_support.set_property('symbol', data, data_types, False, [], False, False, class_name)

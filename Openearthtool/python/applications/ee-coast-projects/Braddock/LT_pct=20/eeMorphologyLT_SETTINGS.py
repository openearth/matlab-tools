...
#project name
name = 'Braddock'   #name for output images/videos/features
...
#temporal settings
years = range(2010,2016) #range of years for LT analysis
...
projdir = os.path.join(projdir,name) #get the outdir for the chosen location
...
shutil.copyfile(os.path.join(curr,'eeMorphologyLT.py'),os.path.join(outdir,'eeMorphologyLT_SETTINGS.py'))

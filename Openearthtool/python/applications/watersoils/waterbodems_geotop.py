...
# $Id: waterbodems_geotop.py 12746 2016-05-20 12:35:24Z sala_joan $
# $Date: 2016-08-22 14:35:24 +0200 (Mon, 22 Aug 2016) $
# $Author: sala $
# $Revision: 12746 $
# $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/python/applications/waterbodems/waterbodems_geotop.py $
# $Keywords: $
...
"""
Waterbodems geotop WPS start script
...
class Process(WPSProcess):
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            identifier="waterbodems_geotop",
                            title="waterbodems_geotop",
                            version="1.0",
                            storeSupported="true",
    ...
    def execute(self):
        ...
        for xin,yin in ls.coordsfinal:          
            ...
            try:
                ...
                geotop = GeoTopOnOpendap('d:\\data\\geotop.nc').get_all_layers(x, y)
                minv = geotop[0][2]
                maxv = geotop[-1][3]
                dt = {}                    
                dt['dist'] = dist
        ...
        values['title'] = """GEOTOP (orientation {})""".format(orientation)
        plot = waterbodems_Plot(values, temp_html, depth, colorTable='GEOTOP')
        plot.generate_plot()        

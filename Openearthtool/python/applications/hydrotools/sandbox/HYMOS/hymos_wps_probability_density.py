...
http://localhost/cgi-bin/pywps.cgi?&service=wps&version=1.0.0&request=DescribeProcess&identifier=hymos_wps_probability_density
http://localhost/cgi-bin/pywps.cgi?&service=wps&version=1.0.0&request=Execute&identifier=hymos_wps_probability_density&datainputs=[parameterid=P.obs;locations=M_AZ_001;startdate=20090101;enddate=20100101]
...
URL of source:           $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/python/applications/hydrotools/sandbox/HYMOS/hymos_wps_probability_density.py $
CodeID:                  $ID$
...
class Process(WPSProcess):
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            identifier="hymos_wps_probability_density",
                            title="""Probability density function""",
                            abstract="""Get time series from database and
                            determine the probability density fucntion.
                            Returns the probability density
                            function.
                            Method used is gaussian Kernel density estimator.
                            """,
                            version="1.1",
                            storeSupported=True,
        ...
        self.locations = self.addLiteralInput(
            ...
            title="Locations selected for probability density plot",
    ...
    def execute(self):
        ...
        if len(self.sdate.getValue()) < 8:
            ...
            if len(self.edate.getValue()) < 8:
                ...
                io = bokeh_plots.bokeh_probability_density(

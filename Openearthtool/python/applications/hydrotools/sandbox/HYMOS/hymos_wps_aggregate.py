...
http://localhost/cgi-bin/pywps.cgi?&service=wps&version=1.0.0&request=DescribeProcess&identifier=hymos_wps_aggregate
http://localhost/cgi-bin/pywps.cgi?&service=wps&version=1.0.0&request=Execute&identifier=hymos_wps_aggregate&datainputs=[parameterid=P.obs;locations=M_AZ_001;startdate=20090101;enddate=20100101;timestep=5]
...
URL of source:           $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/python/applications/hydrotools/sandbox/HYMOS/hymos_wps_aggregate.py $
CodeID:                  $ID$
...
class Process(WPSProcess):
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            identifier="hymos_wps_aggregate",
        ...
        self.locations = self.addLiteralInput(
            ...
            title="Locations selected for aggregation",
        ...
        self.timestep = self.addLiteralInput(
            identifier="timestep",
            title="Aggregation time step in days",
    ...
    def execute(self):
        ...
        logging.info('time step   %s', self.timestep.getValue())
        ...
        if len(self.sdate.getValue()) < 8:
            ...
            if len(self.edate.getValue()) < 8:
                ...
                io = bokeh_plots.bokeh_aggregate(self.parameterID.getValue(),

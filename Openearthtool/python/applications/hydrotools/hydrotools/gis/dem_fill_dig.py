...
should be aplpied before using SRTM HydroSHEDS elevation and flow directions
...
import pdb
import pandas as pd
from hydrotools.gis import gdal_readmap
from hydrotools.gis import gdal_writemap

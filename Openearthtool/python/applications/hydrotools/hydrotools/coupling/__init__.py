"""
This is the __init__ file for hydrotools.coupling
...
hydrotools.coupling.new_file.new_fun

# import functions under the current namespace as follows (preferred for separate functions):
from new_file import *
# now you can call a function new_fun in new_file.py as follows:
hydrotools.coupling.new_fun

$Id: __init__.py 11627 2014-11-27 11:27:46Z eilan_dk $
$Date: Mon Jan 12 15:28:37 2015 $
$Author: eilan_dk $
$Revision: 11627 $
$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/python/applications/hydrotools/hydrotools/coupling/__init__.py $
$Keywords: $

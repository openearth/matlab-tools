...
This script uses a standard xml file created with Geonetwork and exported to a local file.
...
sys.path.append(r'D:\Repos\trunk\metadata') # TEMP SOLUTION! TO DO: SET RELATIVE PATH??
import sqlfunctions
...
if __name__ == '__main__':
    ...
    #cf = r'D:\Repos\trunk\metadata\pgconnectiondataportal.txt'
    cf = r'D:\Repos\trunk\metadata\pgconnectionlocal.txt'
    fxml = r'D:\Repos\trunk\metadata\basis.xml'
    fxls = r'D:\Repos\trunk\metadata\metadata.xlsx'
    tp = r"D:\Repos\trunk\metadata\XMLDir"
    sh = 'sheet1'
    ...
    '''read current content from the database geonetwork, table metadata'''

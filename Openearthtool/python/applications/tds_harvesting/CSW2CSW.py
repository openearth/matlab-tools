...
if __name__ == '__main__':
    ...
    geonetwork_read = {
        'host': 'http://marineprojects.openearth.eu/geonetwork/srv/eng/csw-publication',
        'user': 'admin',
        'pass': 'vreselijk-wachtwoord'
    }
    ...
    geonetwork_test = {
        'host': 'http://tl-tc055.xtr.deltares.nl:8080/dataportaal/srv/eng/csw-publication',
        'user': 'admin',
        'pass': 'admin'
    }

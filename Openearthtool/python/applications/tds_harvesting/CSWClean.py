...
class cswClean:
    ...
    # Delete only records that contain keyword=tds2csw, to avoid other records being deleted
...
if __name__ == '__main__':
    geonetwork = {
        "host": "https://tl-tc112.xtr.deltares.nl:8080/geonetwork/srv/eng/csw-publication",
        "user": "admin",
        "pass": "admin",
    }
    c=cswClean(geonetwork)
    c.clean()
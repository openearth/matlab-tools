...
<head>
  ...
  <!-- <script src="${request.static_url('bmidemo:assets/js/bmidemo.js')}"></script> -->
</head>
<body>
  <section>
    ...
    <div class="container-fluid middle">
      <canvas data-processing-sources="${request.static_url('bmidemo:assets/global/processing/grid.pde')}"></canvas>
    </div>

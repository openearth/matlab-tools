// Copyright (C) (2010) (Fedor Baart) <f.baart@gmail.com>
...
function VideoOverlay(bounds, map, ogg, mp4) {
...
VideoOverlay.prototype = new google.maps.OverlayView();
VideoOverlay.prototype.onAdd = function() {
  ...
  if (this.ogg_ != null) {
    ...
    source.src = this.ogg_;
    source.type ="video/ogg";
    video.appendChild(source);
  }
  if (this.mp4_ != null) {
    var source = document.createElement("source");
    source.src = this.mp4_;
...
VideoOverlay.prototype.draw = function() {
...
VideoOverlay.prototype.onRemove = function() {
  this.div_.parentNode.removeChild(this.div_);
  this.div_ = null;
}

...
class Process(WPSProcess):
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            identifier="blue2_scenario_irrigation",
                            title="Irrigation water savings scenario generation",
                            version="1.0",
                            storeSupported="true",
                            statusSupported="true",
                            abstract="""Please choose an irrigation water savings scenario to be generated. Specify at which spatial scale and the type of analysis. Click on Execute to proceed.""",
                            grassLocation=False)

        self.typescenario = self.addLiteralInput(identifier="typescenario",
                                            title="Irrigation Water Savings",
        ...
        self.previewtype = self.addLiteralInput(identifier="previewtype",
                                            ...
                                            abstract="input=dropdownmenu",
                                            type=type(""),
                                            allowedValues=['Irrigation investment distribution [eur]', 
    ...
    def execute(self):
        ...
        # Call Ramboll script
        ws_cost, ws_improvement, ws_total_efficiency, ws_pop_eq, results = ws_savings_irrig(postgres_db, typescenario, spatialscale)

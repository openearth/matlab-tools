...
class Process(WPSProcess):
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            identifier="comparegreen",
                            title="WFD/GREEN scenario comparison",
                            version="1.0",
                            storeSupported="true",
                            statusSupported="true",
                            abstract="""Compare scenario results from JRC's model GREEN per member state. Obtain difference in parameter values, cost effectiveness and relative increments.""",
                            grassLocation=False)
    ...
    def execute(self):
        ...
        seltable1 = '''{}_{}_{}_{}'''.format(division, 'green', scenario1, variable)
        seltable2 = '''{}_{}_{}_{}'''.format(division, 'green', scenario2, variable)        
        logging.info('''INPUT [comparegreen]: table1={}'''.format(seltable1))
        logging.info('''INPUT [comparegreen]: table2={}'''.format(seltable2))        
        t0=None
        t1=None
        ...
        try:        
            ...
            tmptable1, df1 = calculateLayer(cf, df_thr, seltable1, variable, division, division_id, schema, t0, t1, previewtype, timeseries=False)            
            tmptable2, df2 = calculateLayer(cf, df_thr, seltable2, variable, division, division_id, schema, t0, t1, previewtype, timeseries=False)

...
if __name__ == "__main__":
	...
	# Check params
	if len(sys.argv) != 2:
		print("blue2_import_results requires a configuration file in JSON format, ex: blue2_import_results <conf.json>")
		sys.exit()
	...
	create_sql = '''CREATE SCHEMA IF NOT EXISTS {}'''.format(conf['outputDB']['schema'])

...
# added own unit of measurement which is parsed by our frontend defining the map input picker
...
from processes.downloadNHI import downloadNHI
from processes.info_nhiflux import info_nhiflux
from processes.info_regis import info_regis
from processes.info_geotop import info_geotop
from processes.transect_nhiflux import transect_nhiflux
from processes.transect_regis import transect_regis
from processes.transect_geotop import transect_geotop
from processes.wps_makeprofile import wps_makeprofile
from processes.water_atlas import water_atlas()

processes = [
    UltimateQuestion(), downloadNHI(), info_nhiflux(), info_regis(), info_geotop(
    ), transect_nhiflux(), transect_regis(), transect_geotop(), wps_makeprofile(),water_atlas()
]

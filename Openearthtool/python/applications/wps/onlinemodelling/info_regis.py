...
# $Id: info_regis.py 14075 2018-01-09 09:08:27Z sala $
# $Date: 2018-01-09 10:08:27 +0100 (Tue, 09 Jan 2018) $
# $Author: sala $
# $Revision: 14075 $
...
class Process(WPSProcess):
    ...
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            ...
                            title="Toon ondergrond volgens REGIS",
                            version="1.0",
                            storeSupported="true",
...
#                                         default=3857)
    ...
    def execute(self):
        ...
        logging.info('''INPUT [info_regis]: coordinates_250_rdnew={},{}'''.format(x,y))
        ...
        if data_error:
            ...
            values['title'] = """REGIS (x={} m, y={} m, z={} m-NAP)""".format(int(xo), int(yo), int(maaiveldverschil))

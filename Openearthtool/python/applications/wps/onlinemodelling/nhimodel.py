...
# $Id: nhimodel.py 14055 2018-01-02 09:09:35Z sala $
# $Date: 2018-01-02 10:09:35 +0100 (Tue, 02 Jan 2018) $
# $Author: sala $
# $Revision: 14055 $
# $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/python/applications/wps/onlinemodelling/nhimodel.py $
# $Keywords: $
...
TEMPLATE_RUN=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'nhi_stationary_WPSTEMPLATE.run')
TEMPLATE_IPF=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'nhi_abstraction_WPSTEMPLATE.ipf')
...
class Process(WPSProcess):
    def __init__(self):
        ...
        self.absvolume = self.addLiteralInput(identifier="absvolume",
                                             ...
                                             type=types.IntType, default=-7000)
        ...
        self.margin = self.addLiteralInput(identifier="margin",
                                           ...
                                           type=types.IntType, default=5000)
    ...
    def check_inputs(self, IO, layernb, layernv, absvolume, margin, location, epsgin='epsg:3857'):        
        ...
        try:
            ...
            logging.info('''INPUT [nhimodel]: coordinates_250_rdnew={},{}'''.format(x,y))            
        except:
    ...
    def execute(self):
        ...
        logging.info('''INPUT [nhimodel]: absvolume={}, layernb={}, layernv={}, location={}'''.format(absvolume, layernb,layernv,str(self.location.getValue)))
     
        # Error messaging
        okparams, msg, x, y, xe, ye = self.check_inputs(IO, layernb, layernv, absvolume, margin, location)
        if not(okparams):            
            logging.info(msg)            
        ...
        runfile, bbox_rdnew, bbox = RUN.setupModelRUN(tmpdir, ipffile, layernb, xe, ye, margin)        

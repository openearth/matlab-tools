...
from processes.brl_watercourses import WpsBRLWatercourse
from processes.brl_init import WpsBRLInit
from processes.brl_gwmodel import WpsBRLGWModel

processes = [
    UltimateQuestion(),WpsBRLWatercourse(),WpsBRLInit(),WpsBRLGWModel()
]

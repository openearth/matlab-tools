...
# $Date: 2018-01-30 23:01:10 -0800 (Tue, 30 Jan 2018) $
# $Author: sala $
# $Revision: 14134 $
# $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/python/applications/wps/emisk/3dDEM.py $
# $Keywords: $
...
class Process(WPSProcess):
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            identifier="3dDEM",
                            title="3D Digital Elevation Model [interactive]",
                            version="1.0",
                            storeSupported="true",
                            statusSupported="true",
                            abstract="""Select a bounding box and click Execute to get an interactive plot of the DEM 90m data.""",
                            grassLocation=False)
    ...
    def execute(self):
        ...
        layer = 'Geology:Kuwait_DEM90' 
        logging.info('''INPUT [3d_dem]: layer={}, location={}'''.format(layer, str(location)))

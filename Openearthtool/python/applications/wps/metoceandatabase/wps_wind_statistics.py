...
class Process(WPSProcess):
    ...
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            identifier="wps_wind_statistics",
                            title="""Wind statistics """,
                            abstract="""Statistics (Return Period and Homogeneous check) on Wind direction and speed yearly or monthly from 1979-2015
                            """,
                            version="1.1",
                            storeSupported=True,
        ...
        self.type = self.addLiteralInput(
            identifier="type",
            title="Return period values U10 or homogeneous check",
            abstract="input=dropdownmenu",
            type=type(""),
            allowedValues=["Return Period", "Homogeneous check"],
    ...
    def execute(self):
        ...
        if self.type.getValue() == "Return Period":
            mode = ["rvp"]
        elif self.type.getValue() == "Homogeneous check":

...
##KERNEL FOR SEGMENTING ROAD AND AGGREGATING HAZARD MAP VALUES
...
r = multilinestring_list_to_multilinestring(gdf_geometry)  # returns 1 multilinestring object
# containing all linestrings contained in gdf_geometry

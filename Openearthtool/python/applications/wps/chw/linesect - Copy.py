...
class Process(WPSProcess):
    def __init__(self):
        ...
        self.json = self.addComplexOutput(identifier  = "values",
                                             ...
                                             formats     = [{"mimeType":"text/json","encoding": "utf-8"}, # 1st is default
                                                           {'mimeType':"text/html","encoding": "utf-8"}])

        self.chwlist = self.addComplexOutput(identifier  = "values",
...
#                                                  "encoding": "utf-8",}])
    ...
    def execute(self):
        ...
        io,io2 = getdata.main(awktline,acrs)    
#        self.chwlist.setValue(io)
#        io.close()
#        return
...
#        logging.info(type(self.json.getvalue()))
#        logging.info(type(self.chwlist.getvalue()))
        io2.close()
        logging.info("Hello")
        return

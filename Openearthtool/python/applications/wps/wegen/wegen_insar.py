...
# $Date: 2018-04-06 10:43:39 +0200 (Fri, 06 Apr 2018) $
# $Author: sala $
# $Revision: 14277 $
...
"""
http://localhost/cgi-bin/pywps.cgi?service=wps&request=DescribeProcess&version=1.0.0&identifier=wegen_insar
http://localhost/cgi-bin/pywps.cgi?service=wps&request=Execute&version=1.0.0&identifier=wegen_insar&datainputs=[location=POINT(528660.3,6812261.1)]
"""
...
class Process(WPSProcess):
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            identifier="wegen_insar",
                            title="Tijdreeks voor INSAR locatie",
                            version="1.0",
                            storeSupported="true",
                            statusSupported="true",
                            abstract="""Toon meetreeks van de locaties waarvoor INSARwaarden beschikbaar zijn""",
                            grassLocation=False)
    ...
    def execute(self):
        ...
        tmpfile =  getdata(PLOTS_DIR,APACHE_DIR, location)
        logging.info(tmpfile)
        values['url_plot'] = tmpfile
        values['plot_xsize'] = 700
        values['plot_ysize'] = 300

...
class Process(WPSProcess):
    def __init__(self):
        ...
        WPSProcess.__init__(self,
            identifier = "tidal_predict_range",
        ...
        self.tideout = self.addLiteralOutput(identifier="tideout",
    ...
    def execute(self):
        ...
        def h(lon, lat, t):
            ...
            for constituent, row in interps.iterrows():
                ...
                #print h
            return h
        #dates = [datetime.datetime(self.yearIn.getValue(),self.monthIn.getValue(),self.dayIn.getValue(),self.hourIn.getValue(),self.minuteIn.getValue())]        
        #output = h(self.lonIn.getValue(),self.latIn.getValue(), dates)
	#print lon, lat, dates	         
        #self.tideout.setValue(output)
        ...
        output = np.array2string(h(self.lonIn.getValue(),self.latIn.getValue(), dates))[1:-1]
        self.tideout.setValue(pandas.Series(data=output, index=dates))               
        return

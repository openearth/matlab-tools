# cdi_plot_profile returns a scatter/profile plot of one parameter from a remote ODV file as png
...
# $Id: cdi_plot_profile.py 11429 2014-11-24 18:13:50Z santinel $
# $Date: 2014-11-24 10:13:50 -0800 (Mon, 24 Nov 2014) $
# $Author: santinel $
# $Revision: 11429 $
# $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/python/applications/wps/processes/cdi_plot_profile.py $
# $Keywords: $
...
class odvProcess(WPSProcess):
    def __init__(self):
        WPSProcess.__init__(self,
                            identifier="cdi_plot_profile", # must be same, as filename
                            ...
                            version="$Id: cdi_plot_profile.py 11429 2014-11-24 18:13:50Z santinel $",
                            storeSupported=True,
                            statusSupported=True,
                            abstract="returns a scatter/profile plot of 1 parameter from a remote cdi as png",
                            grassLocation=False)
...
# so either do a prior clean-up, or add a unique code and schedule a cleanup batch
    ...
    def execute(self):
        ...
        # logging.info("cdi_plot_profile: tempPath: " + tempPath)
        # logging.info("cdi_plot_profile: dataPath: " + dataPath)
        ...
        if dataPath[0:13]=='postgresql://':
            ...
            logging.info("cdi_plot_profile: ODV read from PostgreSQL with n=" + str(len(ODV.data)))
...
# PNG: (clean-up if needed)
        ...
        pyodv.odv2profile(tempname_png,ODV,self.parameter.getValue(),clims,zlims,times,cmapstr,self.log10.getValue(),zname,colorvalue,markertype,markersizevalue,linestylevalue,linewidthvalue,alphavalue)

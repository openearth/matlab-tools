...
from scipy.ndimage import map_coordinates # als deze import niet wordt gebruikt dan werkt de WPS, anders verschijnt hij niet eens in de GetCapabilities
...
class LS:
    ...
    def intersect(self, all_box=False):
        """Returns values of line intersection on downloaded geotiff from wcs."""

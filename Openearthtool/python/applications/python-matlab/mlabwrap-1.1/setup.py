...
MATLAB_COMMAND = 'matlab'   # (just 'matlab' for windows) specify a full path if not in PATH
MATLAB_VERSION = LooseVersion('7.10')       # e.g: 6 (one of (6, 6.5, 7, 7.3))
                            #      7.3 includes later versions as well
MATLAB_DIR='/Applications/MATLAB_R2010a.app'            # e.g: '/usr/local/matlab'; 'c:/matlab6'
PLATFORM_DIR='maci'           # e.g: 'glnx86'; r'win32/microsoft/msvc60'

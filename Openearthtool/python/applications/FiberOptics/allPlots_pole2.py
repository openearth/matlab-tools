...
## INPUTS
poleHeightFile = 'D:\sala\Documents\Fiber_Optics\data\layout_length_depth_poles\pole2.csv'
poleName = os.path.basename(poleHeightFile).replace('.csv', '')
poleExpFiles = [
    'D:\sala\Documents\Fiber_Optics\data\pole2\ch1_pole2_exp1.csv',
    'D:\sala\Documents\Fiber_Optics\data\pole2\ch1_pole2_exp2.csv',
    'D:\sala\Documents\Fiber_Optics\data\pole2\ch1_pole2_exp3.csv'
]
...
for poleExpFile in poleExpFiles:
    ...
    ## HEATMAP
    hm = heatmap_Plot(pf)
    hm.heatmap('Heatmap for '+ os.path.basename(poleExpFile).replace('.csv', '') + ' on ' + pf.date,

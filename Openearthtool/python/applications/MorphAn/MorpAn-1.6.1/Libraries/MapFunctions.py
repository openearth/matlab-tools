...
from NetTopologySuite.Geometries import LineString as _LineString
from NetTopologySuite.Geometries import Point as _Point
from GeoAPI.Geometries import Coordinate as _Coordinate
...
def CreateLineGeometry(coordinateList):
    ...
    return _LineString(_Array[_Coordinate](list))

...
from System.Windows.Forms import DataGridView,FormBorderStyle

def btnOK_Click(sender, e):
	
	frmDateTime.Visible = False

frmDateTime = Form()
frmDateTime.Width = 845
frmDateTime.Height = 470
frmDateTime.Text="Date-time format"
#frmDateTime.FormBorderStyle = FormBorderStyle.FixedDialog

rtbDateFormat = RichTextBox()
...
frmDateTime.Controls.Add(rtbDateFormat)
frmDateTime.Controls.Add(btnOK)

...
def plot_tide(data,titler,xlabel,ylabel):
	...
	from Scripts.TidalData.tide_stats import *
	import math as math
	...
	chart.LeftAxis.Minimum = math.floor(getLAT(data)/0.5)*0.5 
	chart.LeftAxis.Maximum =  math.ceil(getHAT(data)/0.5)*0.5
...
def add_series(chart,stat_data,lim_data):
	...
	func_dict = {7:getLAT, 6:getMLWS, 5:getMLWN, 4:getMSL, 3:getMHWN, 2:getMHWS, 1:getHAT}

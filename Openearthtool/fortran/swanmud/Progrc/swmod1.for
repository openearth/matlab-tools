...
!     40.61mud,Oct. 06: NMOVAR increased by 2 (quantity WLENMR
!                     and WLENMI added)
!     40.61mud,Oct. 07: NMOVAR increased by 1 (quantity MUDL added)
!
!  2. Purpose
!
...
!  6. Parameter variables
!
!     NMOVAR [  60]  maximum number of output variables                   40.61 40.51 40.21 40.41 40.61mud
!     MOUTPA [   5]  number of output parameters
!
      INTEGER NMOVAR, MOUTPA
      PARAMETER (NMOVAR = 60, MOUTPA=5)                                   40.61 40.51 40.21 40.41 40.61mud should be dependent on IMUD
!
!  7. Local variables
!
...
!  (57) [                    'Fluid mud dissipation']
!  (58) [   'Average wave length with mud real part'] 40.61mud
!  (59) [   'Average wave length with mud imag part'] 40.61mud
!  (60) [                       'Mudlayer thickness'] 40.61mud
...
!  (58) [CALCULAT] =UL 40.61mud
!  (59) [CALCULAT] =UL 40.61mud
!  (60) [CALCULAT] =UH 50.61G
...
!  (56)  [  1]   Diswcp
!  (57)  [  1]   Dismud
!  (58)  [  1]   Wlenmr 40.61mud
!  (59)  [  1]   Wlenmi 40.61mud
!  (60)  [  1]   Mudl   40.61mud
...
!  (56)  [   -10.] Diswcp
!  (57)  [   -10.] Dismud
!  (58)  [   -10.] Wlenmr 40.61mud
!  (59)  [   -10.] Wlenmi 40.61mud
!  (60)  [   -99.] Mudl   40.61mud
...
!  (56)  [     0.] Diswcp
!  (57)  [     0.] Dismud
!  (58)  [     0.] Wlenmr 40.61mud
!  (59)  [     0.] Wlenmi 40.61mud
!  (60)  [  -100.] Mudl   40.61mud
...
!  (56)  [  1000.] Diswcp
!  (57)  [  1000.] Dismud
!  (58)  [  1000.] Wlenmr 40.61mud
!  (59)  [     5.] Wlenmi 40.61mud
!  (60)  [   1.E4] Mudl   40.61mud
! SINCQ  [       ] sin of ALCQ
! SINPQ  [       ] sin of ALPQ
...
C     MICMAX [  10] max. number of points in comput. stencil
...
! JDISB  [ 11] within array SWMATR
! JDISM  [ 14] within array SWMATR
! JDISS  [  2] dissipation within array COMPDA
! JDISU  [ 12] within array SWMATR
! JDISW  [ 13] within array SWMATR
! JWLMR  [ 15] within array SWMATR                                        40.61mud
! JWLMI  [ 16] within array SWMATR                                        40.61mud
...
! JDSXB  [ 29] bottom friction dissipation within array COMPDA
! JDSXM  [ 32] fluid mud dissipation within array COMPDA
! JDSXS  [ 30] surf dissipation within array COMPDA
! JDSXW  [ 31] whitecapping dissipation within array COMPDA
...
! JLMR   [   ] Average wave length with mud real part array COMPDA        40.61mud
! JLMI   [   ] Average wave length with mud imag part array COMPDA        40.61mud
! JKWVI  [  1] imag part of mud wave number in array COMPSPC              40.61mud
! JKWVR  [  1] real part of mud wave number in array COMPSPC              40.61mud
...
! JPMUD  [  9] within array SWTSDA, fluid mud dissipation
...
!              set by command WCAP JANS ...
! MCMVAR [ 32] within array COMPDA,                                       40.61mud
...
! MCSVAR  [   ] within array COMPSPC                                      40.61mud
!
...
!     index into          COMPDA(:,J#)  SWMATR(:,:,J#)                    40.61mud
      INTEGER             JDISB,       JDSXB
      INTEGER             JDISU,       JDSXS
      INTEGER             JDISW,       JDSXW
      INTEGER             JDISM,       JDSXM
      INTEGER             JWLMR,       JLMR                              !40.61mud
      INTEGER             JWLMI,       JLMI                              !40.61mud
      ...
      INTEGER             MCMVAR,      MCSVAR,      MTSVAR,      JURSEL   40.61mud
      INTEGER             MSWMATR,     MLSWMAT
      INTEGER             JKWVI,       JKWVR                              40.61mud
!
...
! ICOMP  [     1]  unused
C IXCGRD [      ]  IX of points of computational stencil
C IYCGRD [      ]  IY of points of computational stencil
...
C CSETUP [  true] indicates whether solver for setup has converged
...
!                 =1; dissipation due to fluid mud according to
...
!  ( 1)  [    1.] =alpha;   set by command MUD ... [alpha] ...
!  ( 2)  [ 1300.] =rhom;    set by command MUD ... [rhom] ...
!  ( 3)  [   RHO] =rho0;    set by command MUD ... [rho0] ...
!  ( 4)  [0.0027] =nu;      set by command MUD ... [nu] ...
!  ( 5)  [    0.] =layer;   set by command MUD ... [layer] ...
!  ( 6)  [     0] =disperr; set by command MUD ... [disperr] ... ! 40.61mud
!  ( 7)  [     0] =disperi; set by command MUD ... [disperi] ... ! 40.61mud
!  ( 8)  [     0] =source ; set by command MUD ... [source ] ... ! 40.61mud
!  ( 9)  [     0] =cg     ; set by command MUD ... [cg     ] ... ! 40.61mud
...
C IPTST  [      ] sequence number of a test point
...
C TESTFL [   FAL] test output must/must not be made, mainly for testpoints
...
!
C COSLAT [    10] cos of latitude; =1 for Cartesian coordinates
...
C PROPSL [CALCUL] indicates which numerical scheme is used locally

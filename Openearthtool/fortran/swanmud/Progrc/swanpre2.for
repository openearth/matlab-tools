...
!             DHSIGN/DRTM01/LEAK/XP/YP/DIST/SETUP/TMM10/RTMM10/TMBOT/       &
!             WATLEV/BOTLEV/TPS/DISBOT/DISSURF/DISWCAP >  ([unit])          &
...
!CJK request of Arjen L., so error code is reduced from 3 to 1
!CJK         CALL MSGERR(3,                                               40.31
!CJK &          ' keyword SIDE can be used for regular grid only')        40.31
...
!               quantity on file is variance density
              ...
              ELSE
                CALL MSGERR (2,
     &          'instead of EN/VADENS b.c.file has: ' // HEDLIN(1:10))   40.03
                BSPFIL%BFILED(17) = 2                                     40.31
              ENDIF
...
!               quantity on file is Cartesian direction
              ...
              ELSE
                CALL MSGERR (2,
     &          'instead of NDIR,CDIR b.c.file has: ' // HEDLIN(1:10))    40.03
                BSPFIL%BFILED(18) = 1                                     40.31
              ENDIF
...
!               quantity on file is Directional spread in degr
              ...
              ELSE
                CALL MSGERR (2,
     &          'instead of DSPR,DEGR b.c.file has: ' // HEDLIN(1:10))    40.03
                BSPFIL%BFILED(19) = 1                                     40.31
              ENDIF
            ENDIF
...
!           parallel computing                                            40.30
 ...
 104    FORMAT (F14.6, T41, A)                                            40.00
        ...
        WRITE (IFPAR, 102) 'm2/s',   'unit'                               40.00
        WRITE (IFPAR, 104) OVEXCV(7),'exception value'                    40.00
        WRITE (IFPAR, 102) 'Smud',  'fluid mud dissipation'               40.55
...
!           parallel computing                                            40.30
 ...
 220    CONTINUE                                                          40.00
        ...
        WRITE (IFS1D, 102) 'm2',     'unit'                               40.00
        WRITE (IFS1D, 104) OVEXCV(7),'exception value'                    40.00
        WRITE (IFS1D, 102) 'Smud',  'fluid mud dissipation'               40.55
...
!       full 2-D spectrum
 ...
 330    CONTINUE                                                          40.00
        ...
        WRITE (IFS2D, 102) 'm2/degr','unit'                               40.00
        WRITE (IFS2D, 104) OVEXCV(7),'exception value'                    40.00
        WRITE (IFS2D, 102) 'Smud',  'fluid mud dissipation'               40.55

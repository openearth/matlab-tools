function swanmud_damping
%swanmud_damping   unit test for swanmud
%
...
%% plot
   ...
   hold    on
   plot   (TAB.XP,TAB.HS(1).*exp(-TAB.KI.*TAB.XP),'g.','displayname','analytical')
   ylim   ([0 .11])
   ylabel ('H_s [m]')

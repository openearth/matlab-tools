...
libmagic_location = ctypes.util.find_library('magic')
if not libmagic_location:
    libmagic_location = '/opt/local/lib/libmagic.dylib'
libmagic = ctypes.CDLL(libmagic_location)

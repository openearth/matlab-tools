...
rpath = ['c:\Waddenzee\paper\figures\create_inlet_figures\ETD\eld\ELDdam\']
rpath2 = ['"c:\\Waddenzee\\paper\\figures\\create_inlet_figures\\ETD\\eld\\ELDdam\\']
...
for Y = 1:length(year)
    ...
    fprintf(fid, 'XAxis      115469.9184 120539.3374\n');
    fprintf(fid, 'YAxis      575493.22 579184.8795\n');

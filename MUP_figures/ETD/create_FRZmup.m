...
year = {'1926','1949','1955','1957','1967','1970','1974','1975','1979','1982','1987','1991','1994','1996','1997','1999','2000','2002','2005'};
...
for Y = 1:length(year)
    ...
    fprintf(fid, 'FileType  "Polyline"\n');
    fprintf(fid, ['File     ' char(rpath3) 'Frz_buiten_tot.ldb"']);fprintf(fid,'\n');
    fprintf(fid, 'EndDataset\n');fprintf(fid,'\n');
    ...
    fprintf(fid, 'XAxis      180540.2396 209929.2581\n');
    fprintf(fid, 'YAxis      603802.8387 625204.5513\n');
    ...
    fprintf(fid, 'Scale     133344.004\n');
    fprintf(fid, ['Title      "Friesche Zeegat ' char(year(Y)) '"']);fprintf(fid, '\n');

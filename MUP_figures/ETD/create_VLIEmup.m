...
year = {'1933','1972','1978','1982','1988','1992','1995','1998','2000','2002'};
...
for Y = 1:length(year)
    ...
    fprintf(fid, 'FileType  "Polyline"\n');
    fprintf(fid, ['File     ' char(rpath3) 'Vlie_buiten_tot.ldb"']);fprintf(fid,'\n');
    fprintf(fid, 'EndDataset\n');fprintf(fid,'\n');
    ...
    fprintf(fid, 'XAxis      117759.8584 152392.121\n');
    fprintf(fid, 'YAxis      586319.9603 611539.9155\n');
    ...
    fprintf(fid, 'Scale     157133.6777\n');
    fprintf(fid, ['Title      "Vlie ' char(year(Y)) '"']);fprintf(fid, '\n');
    fprintf(fid, 'XLabel     "X [km]"\n');
    fprintf(fid, 'YLabel     "Y [km]"\n');
    fprintf(fid, 'Colormap   "jet"\n');
    fprintf(fid, 'ColorBar   yes\n');
    fprintf(fid, 'ColorBarPosition 2.5           8         0.5           9\n');

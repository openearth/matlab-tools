...
year = {'1925','1933','1950','1973','1981','1986','1991','1993','1994','1997','1999','2001','2003','2006','2009'};
...
for Y = 1:length(year)
    ...
    fprintf(fid, 'FileType  "Polyline"\n');
    fprintf(fid, ['File     ' char(rpath3) 'Md_buiten_tot.ldb"']);fprintf(fid,'\n');
    fprintf(fid, 'EndDataset\n');fprintf(fid,'\n');
    ...
    fprintf(fid, 'XAxis      93500 119000\n');
    fprintf(fid, 'YAxis      535774.9962 569912.093\n');
    ...
    fprintf(fid, 'Scale     137096.7742\n');
    fprintf(fid, ['Title      "Marsdiep ' char(year(Y)) '"']);fprintf(fid, '\n');

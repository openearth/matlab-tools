...
year = {'1926','1933','1958','1966','1974','1979','1989','1993','1996','1999','2004'};
...
for Y = 1:length(year)
    ...
    fprintf(fid, 'FileType  "Polyline"\n');
    fprintf(fid, ['File     ' char(rpath3) 'Ame_buiten_tot.ldb"']);fprintf(fid,'\n');
    fprintf(fid, 'EndDataset\n');fprintf(fid,'\n');
    ...
    fprintf(fid, 'XAxis      148563.9126 182777.9896\n');
    fprintf(fid, 'YAxis      597946.4934 622861.917\n');
    ...
    fprintf(fid, 'Scale     155236.2838\n');
    fprintf(fid, ['Title      "Ameland ' char(year(Y)) '"']);fprintf(fid, '\n');

...
year = {'1927','1958','1970','1975','1979','1982','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','19976','2000','2002','20056','2007'};
...
for Y = 1:length(year)
    ...
    fprintf(fid, 'FileType  "Polyline"\n');
    fprintf(fid, ['File     ' char(rpath3) 'Eems_buiten_tot.ldb"']);fprintf(fid,'\n');
    fprintf(fid, 'EndDataset\n');fprintf(fid,'\n');

    x = 25.04;  %letter 8'5 x 11"  minus 1" margins
    y = 19.05;
    ...
    fprintf(fid, 'XAxis      206685.4422 238123.2134\n');
    fprintf(fid, 'YAxis      606826.755 629720.4133\n');
    ...
    fprintf(fid, 'Scale     142639.6153\n');
    fprintf(fid, ['Title      "Eems Dollard ' char(year(Y)) '"']);fprintf(fid, '\n');
    fprintf(fid, 'XLabel     "X [km]"\n');
    fprintf(fid, 'YLabel     "Y [km]"\n');
    fprintf(fid, 'Colormap   "jet"\n');
    fprintf(fid, 'ColorBar   yes\n');
    fprintf(fid, 'ColorBarPosition 2.5          2.5         12.5          0.5\n');

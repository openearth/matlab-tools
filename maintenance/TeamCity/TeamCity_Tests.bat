...
rem -----------------------------------
net use m: /delete
net use m: \\wlhost\library %openearth_password% /USER:%openearth_user% 
...
M:\app\MATLAB2010a\bin\matlab.exe -nosplash -nodesktop -minimize -r "TeamCity_runtests;" -logfile mlogfile.log -sd "%teamcity.build.workingDir%"

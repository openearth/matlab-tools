...
function CreateTestExplorer()
{
    ...
    d = CreateTreeItem( rootCell, "img/folder_closed.gif", "img/folder_open.gif", "Test Results ", null, null );
<!-- ##BEGINTESTS -->
...
<body onLoad="CreateTestExplorer();" class="treeview_menu" background="#A5E0E3">
</body>
</html>

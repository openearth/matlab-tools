...
switch mfilename
    case {'prob_calculation_tutorial',...
            ...
            'xb_run_tutorial', 'xb_readresults_tutorial'}
        config.evalCode = false;
        config.showCode = true;
    case {'runningatest_tutorial',...
            'runtestswithmtestengine_tutorial',...
            '_tutorial_netCDF_create',...
            '_tutorial_netCDF_read_functions',...
            'KMLline_tutorial',...
            'jarkus_tutorial_coordinates_RSP_2_RD',...
            'jarkus_tutorial_reading_data_1',...
            'jarkus_tutorial_calculate_MKL',...
            'jarkus_tutorial_calculate_volume',...
            'convertCoordinates_tutorial',...
            ...
            'tutorials_publish_oet_style_tutorial'}
        if ~oldpublish

...
<head>
	...
	<link rel="stylesheet" href="html/script/css/jquery.treeview.css" />
    	...
    	<link rel="stylesheet" href="html/script/css/matlabcode.css" />
	...
	function loadcontent(event)
		{
		$("#contentspanel").load(event.data.html +" div.content",".content",function()
			{
	...
	function finishtutorials()
		{
				...
				// link images otherwise IE will mess up all images.
				linkimages();

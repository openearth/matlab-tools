...
% $Revision: 1.1.6.12 $  $Date: 2007/08/08 23:00:05 $
...
if getpref('PUBLISH','SnapChangedModels',false)
    openSystemList = find_system('LookUnderMasks','all','Open','on');
...
if getpref('PUBLISH','SnapChangedModels',false)
    ...
    systemsToSnap = setdiff(find_system('LookUnderMasks','all','Open','on'),oldOpenSystems);
end

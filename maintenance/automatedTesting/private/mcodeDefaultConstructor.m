...
if ~is_xauto 
    hCode.addPostConstructorText('% Uncomment the following line to preserve the X-limits of the axes');
    hArg = codegen.codeargument('Value',xlm);
    hCode.addPostConstructorText('% xlim(',hArg,');');
end
if ~is_yauto
    hCode.addPostConstructorText('% Uncomment the following line to preserve the Y-limits of the axes');
    hArg = codegen.codeargument('Value',ylm);
    hCode.addPostConstructorText('% ylim(',hArg,');');
end
if ~is_zauto
    hCode.addPostConstructorText('% Uncomment the following line to preserve the Z-limits of the axes');
    hArg = codegen.codeargument('Value',zlm);
    hCode.addPostConstructorText('% zlim(',hArg,');');
end
...
%---------------------------------------------------------%
function local_CreateAxesHelperFunction(hObj,hCode,fname,fval) %#ok<INUSL>

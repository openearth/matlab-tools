function htmlDir = publish_OET_documentation(varargin)
...
OPT = struct(...
    ...
    'index','menu',...
    'search','on');
OPT.htmlDir = [oetroot filesep 'docs' filesep 'OpenEarthHtmlDocs' filesep OPT.template filesep];

OPT = setproperty(OPT,varargin{:});

% execute m2html
m2html_AM('mFiles',OPT.mFiles,...
    'htmlDir',OPT.htmlDir,...
    'source',OPT.source,...
    'recursive',OPT.recursive,...
    'ignoredDir',OPT.ignoredDir,...
    'search',OPT.search,...
    'excludedFiles',OPT.excludedFiles,...

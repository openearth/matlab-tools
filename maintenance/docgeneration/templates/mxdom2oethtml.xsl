...
<xsl:template name="header">
    <hr color="#006699" size="18"></hr>
    <!-- This image should be in the same directory or the final path should be altered. XSL does not copy files -->
    <img src="#REF OET.jpg"></img><span style='font-size:xx-large;color:#003366;font-weight: bold'>	OpenEarth Tools</span>
    <hr color="#006699" size="18"></hr>
</xsl:template>

...
switch mfilename
    ...
    case {'testdefinitions_tutorial',...
            ...
            'KMLline_tutorial',...
            'jarkus_tutorial_coordinates_RSP_2_RD.m',...
            'jarkus_tutorial_reading_data_1.m',...
            'jarkus_tutorial_calculate_MKL.m',...
            'jarkus_tutorial_calculate_volume.m',...
            'convertCoordinates_tutorial.m'}
        if ~oldpublish

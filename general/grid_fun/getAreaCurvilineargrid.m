function AreaAB = getAreaCurvilineargrid(Xcorner,Ycorner,varargin)
%GETAREACURVILINEARGRID   calculate area matrix from (x,y) coordinate matrices
%
%  area = getAreaCurvilineargrid(xcorner,ycorner) returns the areas 
...
%                    --o--                 ---o-----------o
%
%  area = getAreaCurvilineargrid(XXcorner,Ycorner,<keyword,value>)

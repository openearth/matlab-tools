...
%% and now modify, start with deleting empty sheets, clean current sheet and reload data again (avoid leftovers of previous manipulations)
delete_empty_excelsheets(filename);
cleanSheet              (filename,sheetname);
xlswrite                (filename,cell_arr,sheetname);

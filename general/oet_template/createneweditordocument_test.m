...
createneweditordocument('test');

document = com.mathworks.mlservices.MLEditorServices.getEditorApplication.getLastActiveEditorViewClient.getEditor;
len = document.getLength;
document.closeNoPrompt;

assert(len==length('test'));

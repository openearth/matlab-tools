...
%
%   Syntax:
%   [x_ds3,y_ds3]=nemo_northarrow(d,x0,y0,theta0,c)
%
...
if nargin==1 %'auto' Automatically scale and place.
    ...
    patch('XData',x_ds3([1:3,5]),'YData',y_ds3([1:3,5]),'FaceColor','k','EdgeColor',OPT.c);
    patch('XData',x_ds3([3:6])  ,'YData',y_ds3([3:6])  ,'FaceColor','w','EdgeColor',OPT.c);

    %plot(x_ds3,y_ds3,c,'linewidth',2);
    t1=text(x0,y0-0.5*d,'N');

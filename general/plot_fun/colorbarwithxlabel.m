...
%
%   colorbarwithxlabel(colorbartxt) (re)draws the colorbar
%   with besides above it.
%
%   colorbarwithxlabel(colorbartxt,ctick) (re)draws the colorbar
%   with tick marks at positions ctick.
%
%   [h]=colorbarwithxlabel(colorbartxt) does the same
%   and returns the handle h of the colorbar.
%
%   [ax, h]=colorbarwithxlabel(colorbartxt,<ctick>) 
...
%
%   colorbarwithxlabel(colorbartxt,arguments) or
%   colorbarwithxlabel(colorbartxt,ctick,arguments) passes arguments
%   to colorbar
%

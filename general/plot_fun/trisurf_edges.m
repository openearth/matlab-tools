...
%
%   Output:
%   E = is a matrix, contains the coordinates of all points, and their connectivity [x1,y1,z1,x2,y2,z2,previous,next]
%
%   Example
%   trisurf_edges
%
...
edgeIndices(:,[3 4]) = 0; % The index of the next line will be stored here
previousEdgeIndex = 0;
ii = 1;

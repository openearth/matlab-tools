...
%% Draw arrows
   ...
   if strcmp(lower(quiverfun),'quiver')
       ...
       %   strcmp(release(1:3),'200') | strcmp(release(1:4),'2010') % arrow head is fixed in 2011a
       ...
       %                 y(1:d1:end,1:d2:end),...
       %                 u(1:d1:end,1:d2:end).*uscale,...
       %                 v(1:d1:end,1:d2:end).*vscale,0,varargin{linespecargs},'MaxHeadSize', OPT.MaxHeadSize);
       %end

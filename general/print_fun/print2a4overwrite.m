function print2a4overwrite(fname,varargin)
%PRINT2A4OVERWRITE    Print figure to A4 paper size.
%
% print2a4overwrite(fname)
% print2a4overwrite(fname,PaperOrientation)
% print2a4overwrite(fname,PaperOrientation,Tall_Wide)
% print2a4overwrite(fname,PaperOrientation,Tall_Wide,resolution)
%
...
%  +----------+ +-------+
%                                                    
% where print2a4overwrite'tst','v','t') matches screen best
% where print2a4overwrite'tst','h','t') matches landscape figure on portrait printer best
%       print2a4overwrite'tst','v','w') matches upright A4 best
%
%See also: PRINT, PRINT2SCREENSIZE, PRINT2A4

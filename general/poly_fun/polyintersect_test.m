...
if TeamCity.running
    TeamCity.ignore('This test requires user input.');
    return;
end
...
[xr1,yr1]=polyintersect(x1,z1,x2,z2,'debug',1);
[xr1,yr1]
...
[xr2a,yr2a]=polyintersect(x1,z1,x2,z2,'debug',1);
[xr2a,yr2a]
...
[xr3a,yr3a]=polyintersect(x1,z1,x2,z2,'debug',1);
[xr3a,yr3a]

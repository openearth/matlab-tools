...
%% Define meta-info: global
   ...
   OPT.history                = ['tranformation to netCDF: $HeadURL: https://svn.oss.deltares.nl/repos/xbeach/Courses/DSD_2014/Toolbox/io/netcdf/snctools/examples/nc_cf_grid_write_lat_lon_curvilinear_tutorial.m $'];

...
% $Id: xb_plot_mpi.m 4147 2014-10-31 10:12:42Z bieman $
% $Date: 2014-10-31 11:12:42 +0100 (ven, 31 ott 2014) $
% $Author: bieman $
% $Revision: 4147 $
% $HeadURL: https://svn.oss.deltares.nl/repos/xbeach/Courses/DSD_2014/Toolbox/applications/xbeach/xb_visualise/xb_plot_mpi.m $
% $Keywords: $
...
for idomain = 1:size(domains,1)
    ...
    yCornerpoints = [...
        ...
        y(domains(idomain,4), domains(idomain,2))];
    h = plot(ax,xCornerpoints,yCornerpoints,'Color',OPT.Color, 'LineWidth',OPT.LineWidth ,'HandleVisibility','off');
end

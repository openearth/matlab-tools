...
% $Id: delft3d_io_dep.m 16161 2020-01-02 17:16:02Z kaaij $
% $Date: 2020-01-02 09:16:02 -0800 (Thu, 02 Jan 2020) $
% $Author: kaaij $
% $Revision: 16161 $
...
%% Keywords
    ...
    %  for use with $Id: delft3d_io_dep.m 16161 2020-01-02 17:16:02Z kaaij $
    %  for use with $Id: delft3d_io_dep.m 16161 2020-01-02 17:16:02Z kaaij $
    ...
    if ~OPT.meta % meta does not load in GUI
       ...
       metainfo = {['File type                       = Delft3d FLOW depth file (*.dep) (http://www.wldelft.nl/soft/d3d/intro/index.html)'],...
           ...
           ['File written by                 = $Id: delft3d_io_dep.m 16161 2020-01-02 17:16:02Z kaaij $ $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/delft3d/flow/delft3d_io_dep.m $ called from ', OPT.mfilename],...

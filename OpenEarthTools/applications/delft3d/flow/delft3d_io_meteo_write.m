...
% $Id: delft3d_io_meteo_write.m 17023 2021-01-28 02:18:48Z nederhof $
% $Date: 2021-01-27 18:18:48 -0800 (Wed, 27 Jan 2021) $
% $Author: nederhof $
% $Revision: 17023 $
...
if OPT.simpleheader == 0
    ...
    fprintf  (fid,'# Created with $Id: delft3d_io_meteo_write.m 17023 2021-01-28 02:18:48Z nederhof $ $Headurl: $ on %s',datestr(now));
    fprinteol(fid,OPT.OS)

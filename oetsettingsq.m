...
%OETSETTINGSQ Suggested speed improvement for oetsettings
%
% Does not rely on addpathfast, but instead uses dir2.
%
%
%
%
...
%% Add paths
    ...
    % store path before anything is added
    currentPath = path;
    
    % add dir2 function to path
    path(fullfile(basepath,'general','io_fun'), path);
    
    % do a dir commando that excludes all .svn and private directories

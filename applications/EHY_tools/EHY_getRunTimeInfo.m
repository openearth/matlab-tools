function runTimeInfo=EHY_getRunTimeInfo(varargin)
%% runTimeInfo=EHY_getRunTimeInfo(varargin)
%
...
%
% Example1: EHY_getRunTimeInfo
% Example2: runTimeInfo=EHY_getRunTimeInfo('D:\model.mdu')
%

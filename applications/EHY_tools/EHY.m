...
functions{5,2}='A tool to help with using the corrent model input times';
...
figure('units','normalized','position',[0.4922 0.0583 0.5000 0.3000],'name','EHY_TOOLS')
for iF=1:length(functions)
    button=uicontrol('Style', 'pushbutton', 'String',functions{iF,1},...
        'Position', [20 240-iF*30 200 20],...
        'Callback', @runEHYscript);
      uicontrol('Style','text',...
        'Position',[240 240-iF*30-3 1000 20],...

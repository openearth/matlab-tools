...
for i_per = 1: size(Periods,1)
    ...
    for i_stat = 1: no_stat
        if Data.exist_stat(i_stat)
            ...
            [dattim_meas,wlev_meas] = FillGaps(dattim_meas,wlev_meas,'interval',5./1440.); % Fill with NaNs if interval between consequetive measurements is more than 2 hours

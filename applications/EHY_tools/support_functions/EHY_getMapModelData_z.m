...
%% check
[~,dimsInd] = EHY_getDimsInfo(inputFile,OPT,modelType);

if isempty(dimsInd.layers)
    warning(['Data at certain z-level requested, but this is a 2D variabele (' OPT.varName '). The 2D-data will be used as horizontal slice.']);
    Data = DataAll;
    return
end

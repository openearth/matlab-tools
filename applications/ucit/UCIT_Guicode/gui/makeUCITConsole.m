...
'Units','normalized',...
'BackgroundColor',[1 1 1],...
'Callback','UCIT_DC_loadRelevantInfo2Popup(1,4);',...
'ListboxTop',0,...
...
'Units','normalized',...
'BackgroundColor',[1 1 1],...
'Callback','UCIT_DC_loadRelevantInfo2Popup(1,2);',...
'ListboxTop',0,...
...
'Units','normalized',...
'BackgroundColor',[1 1 1],...
'Callback','UCIT_DC_loadRelevantInfo2Popup(1,3);',...
'ListboxTop',0,...
...
'Parent',h1,...
'Units','normalized',...
'Callback','UCIT_DC_loadRelevantInfo2Popup(3,3);',...
'Enable','inactive',...
'ListboxTop',0,...
...
'Parent',h1,...
'Units','normalized',...
'Callback','UCIT_DC_loadRelevantInfo2Popup(3,2);',...
'ListboxTop',0,...
...
'Parent',h1,...
'Units','normalized',...
'Callback','UCIT_DC_loadRelevantInfo2Popup(4,4);',...
'Enable','inactive',...
'ListboxTop',0,...
...
'Parent',h1,...
'Units','normalized',...
'Callback','UCIT_DC_loadRelevantInfo2Popup(4,3);',...
'Enable','inactive',...
'ListboxTop',0,...
...
'Parent',h1,...
'Units','normalized',...
'Callback','UCIT_DC_loadRelevantInfo2Popup(4,2);',...
'ListboxTop',0,...

               ...
               [OPT.inputyears, OPT.coverages] = textread(['coverage' filesep 'timewindow = ' num2str(OPT.timewindow) filesep num2str(fns(i,1).name(1:end-4)) '_coverage.dat'],'%f%f','headerlines',1);
                ...
                if ~isempty(OPT.inputyears)
                    ...
                    for k = 1 : 2 % use 2 methods
                        ...
                        %% write text file
                        fid = fopen([ 'results' filesep 'timewindow = ' num2str(OPT.timewindow) filesep 'ref=' num2str(OPT.min_coverage(n)) filesep fns(i,1).name(1:end-4) '_method' num2str(OPT.type) '.dat'],'w');

...
%% prepare plot
nameInfo=['UCIT - Volume analysis - ', 'Area: ', d.area, '  Transect: ', d.transectID,'  Year: ', num2str(round(str2num(d.year)/365+1970))];
...
result.year                 = num2str(round(str2num(d.year)/365+1970));
...
title({'Momentane Coastline Position (MKL)',['Area: ', d.area, '  Transect: ', d.transectID,'  Year: ',num2str(round(str2num(d.year)/365+1970))]});

...
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ELV/test/reference/011/input_ELV.m $
%
...
input.mdv.output_var = {'u','h','etab','Mak','La','msk','Ls','qbk','time_loop'}; %variables name to output; 

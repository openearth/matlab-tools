...
%$HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/ELV/test/reference/012/input_ELV.m $
%
...
input.mdv.flowtype = 6; %flow assumption: 0=NO update 1=steady; 2=quasi-steady; 3=unsteady explicit; 4=unsteady implicit [-]; [1x1 double]; e.g. [1]
...
input.bch.Q0=[2000; 2000; 6000; 2000]; %water discharge at the specified times [m^3/s]; [ntx1 double]; e.g. [1;2]

...
input.bch.timeetaw0=[0;6*3600;12*3600;18*3600;input.mdv.Tstop]; %time at which the downstream water level is specified [s]; [nix1 double]; e.g. [1800;3600]
% input.bch.etaw0=[0;0]; %downstream water level at the specified times [m]; [nix1 double]; e.g. [1;1.5]
input.bch.etaw0=[0;0.1;0;-0.1;0]; %downstream water level at the specified times [m]; [nix1 double]; e.g. [1;1.5]

function XB = xb_generate_model_1D(varargin)
%XB_GENERATE_MODEL_1D  generate XB-structure for cross-shore XBeach calculation
%
%
%
% syntax:
% XB = xb_generate_model_1D('calcdir', calcdir...
%           'xInitial', xInitial,...
%           'zInitial', zInitial,...
%           'dx', 5, ...
%           'D50', D50,...

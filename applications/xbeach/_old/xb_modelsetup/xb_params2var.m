function varargout = xb_params2var(varargin)
%XB_PARAMS2VAR  create XBeach communication structure out of params-file
%
...
%
%   Example
%   XB = xb_params2var('params.txt')
%
%   See also xb_create_var
...
if ~exist(OPT.filename, 'file')
    warning('XB_PARAMS2VAR:FileNotFound', ['File ' OPT.filename ' not found.'])
end

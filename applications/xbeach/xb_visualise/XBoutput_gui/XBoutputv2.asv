...
%% Data structure
Data.GUI.createDate    = '01-Oct-2009 14:20:10';
Data.GUI.accessDate    = datestr(now);
Data.XB.nVar = 0;
Data.GUI.nDir = 0;
Data.XB.varNames{1}='';
Data.GUI.showVariablesType = 1;
Data.GUI.nPlotVars = 0;
Data.GUI.plotVars = [];
Data.GUI.nDir = 0;
Data.GUI.lastReadPath = '';
Data.GUI.fighandles.fs1 = -1;
Data.GUI.readAsType = 'double';

%% Set up figure
% GUI figure
Data.GUI.fighandles.F=figure('Visible','off','Name','XBeach output GUI','MenuBar','none',...
...
set(Data.GUI.fighandles.F,'Visible','on');


%% Subfunctions calling functions
    function set_directory(hObject,eventdata)
        Data.GUI.current_directory = uigetdir('','Select directory');
        cd(Data.GUI.current_directory);
    end

function xb_read_netcdf_test()
% XB_READ_NETCDF_TEST  One line description goes here
%  
...
variables = xb_read_netcdf(outputfile)
...
variables = xb_read_netcdf(outputfile, 'variables', {'zb'}, 'timestepindex', 100)
assert(~ismember('zs', {variables.name}));

...
delete('test2*.txt');
H = [5:7];
filename = xb_write_waves('jonswap_file','test2','filelist_file','test2_filelist','Hm0',H);
...
delete('test3*.txt');
H = [5:7];
filename = xb_write_waves('jonswap_file','test3','Hm0',H,'omit_filelist',true);
...
freqs = [1:10];
dirs = [1:5];
vardens = [magic(5);magic(5)];
filename = xb_write_waves('vardens_file','test4','type','vardens','freqs',freqs,'dirs',dirs,'vardens',vardens);
...
filename = xb_write_waves('vardens_file','test5','filelist_file','test5_filelist','type','vardens','freqs',freqs,'dirs',dirs,'vardens',vardens);

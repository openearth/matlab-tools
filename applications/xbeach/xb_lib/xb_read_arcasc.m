function [x y z info] = xb_read_arcasc(fname, varargin)
%XB_READ_ARCASC  Reads ASC file generated by ArcGIS
%
...
%
%   Syntax:
%   [x y z info] = xb_read_arcasc(fname, varargin)
%
%   Input:
...
%
%   Example
%   [x y z info] = xb_read_arcasc(fname)
%

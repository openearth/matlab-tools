...
cellfun(@(x,y) rectangle('Position', [x y [S.ncols S.nrows] * S.cellsize]), num2cell(S.xllcorner), num2cell(S.yllcorner))
...
cellfun(@(x,y,name) text(x,y,name, 'VerticalAlignment', 'bottom'), num2cell(S.xllcorner), num2cell(S.yllcorner), S.name);

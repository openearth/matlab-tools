function Donar_MonthClimate(datadirectory)
%Donar_MonthClimate  routine to convert and plot Donar data to monthly averages
%
%   Donar_MonthClimate(datadirectory)
%
% See also: DONAR_READ

...
nc_attput(ncfile, nc_global, 'history', sprintf('%s: %s\n%s', timestr, 'NaN values successively  (1) cross-shore linear interpolated, (2) linear interpolated in time and (3) nearest neighbour extrapolated in time', histstr));
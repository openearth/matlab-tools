...
%------------------
   ...
   OPT.unitss         = {'m'};
   OPT.scales         = [100]; % waterbase uses cm
		      
   OPT.names          = {'concentration_of_suspended_matter_in_sea_water'};
   OPT.standard_names = {'concentration_of_suspended_matter_in_sea_water'};
   OPT.long_names     = {'concentration of suspended matter in sea water'};
   OPT.unitss         = {'kg/m^3'};
...
for ivar=1:length(OPT.names)
   ...
   %------------------
      ...
      nc_varput(outputfile, OPT.name , D.data.(OPT.standard_name));

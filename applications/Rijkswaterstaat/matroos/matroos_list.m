...
%
% matroos_list caches the results and does not connect again to the MATROOS server
% untill i) the next matlab session, ii) a "clear global" is issued, or 
% iii) matroos_list is altered.
%
%See also: matroos

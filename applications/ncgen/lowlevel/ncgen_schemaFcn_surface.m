...
varstruct(end+1) = nccreateVarstruct(...
    ...
    'Datatype'  ,'int16',...
    'Dimensions',{'x','y','time'},...
    'Attributes',{'definition', 'zero based index of source file', 'flag_values', [], 'flag_meanings', ''});
...
ncattributes = [ncattributes {...
    ...
    'date_created', datestr(nowutc, datefmt),...
    'date_modified', datestr(nowutc, datefmt),...
    'date_issued', datestr(nowutc, datefmt),...
    'timeCoverage',''}];

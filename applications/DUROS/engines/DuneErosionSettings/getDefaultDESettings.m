...
DESettings.ParabolicProfile = struct(...
    'c_1',.4714,...
    'c_2',nan,...                                   % Not in use at this moment (but maybe for later use)
    'c_hs',7.6,...
    'cp_hs',1.28,...
    'c_tp',12,...
    'cp_tp',0.45,...
    'c_w',0.0268,...
    'cp_w',0.56,...
    'c_d',nan,...                                   % Not in use at this moment (but maybe for later use)
    'cp_d',nan,...                                  % Not in use at this moment (but maybe for later use)

...
DESettings.ParabolicProfile = struct(...
    'c_1',0.4714,...
    'cp_c1',0,...                                    % coefficient used to include depth effects into c1 (no effect if cp_c1=0)
    'c_2',18,...
    'cp_c2',0,...                                    % coefficient used to include depth effects into c2 (no effect if cp_c2=0)
    'c_hs',7.6,...
    'cp_hs',1.28,...
    ...
    'c_w',0.0268,...
    'cp_w',0.56,...
    'c_d',25,...                                     % Reference depth for D++
    'cp_d',0.106,...                                 % power of depth component in D++ equation   <- !first estimate of this parameter used for test purposes!

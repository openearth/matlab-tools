function testResult = DuneErosionResultProvider_test()
% DUNEEROSIONRESULTPROVIDER_TEST  One line description goes here
%  
...
tr(1) = createEmptyDurosResult_test;
tr(2) = createEmptyXBeachResult_test;

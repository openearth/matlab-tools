...
% -> Specify names of sensors:
    ...
    sensor_fields = {'Air_radiance','Conductivity','Fluorescence','Oxygen','Ph','Salinity','Turbidity','Water_radiance'};
    ...
    for ifile = 1:1:length(files_of_interest)
        ...
        % -> Use this line if you want to plot measurements !!!!
            ...
            theinfo{cont,8} = [theflag,theflagcount];                                  % The (flagged) days
...
%%        
    ...
    for isensor=1:3
        ...
        for ifield = 1:1:numfields
         ...
         % -> Use this line if you want to plot measurements !!!!
                %plot(theplot(:,1),theplot(:,2),'.k','markersize',8);

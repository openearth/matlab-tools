...
% thedon_donar_location_index_vs_time_plot Box and Whisker diagram for all observations in TIME (MONTHS)  
    ...
    filename = ['d:\Dropbox\Deltares\MoS-3\reporting\Garcia Report\figures\timeNspace_ferry_turbidity'];
    disp(['saving : ',filename]);
    print('-dpng',filename);
    saveas(h,filename,'fig');
    ...
    filename = ['d:\Dropbox\Deltares\MoS-3\reporting\Garcia Report\figures\timeNspace_ferry_turbidity_clipped'];
    disp(['saving : ',filename]);
    print('-dpng',filename);
    saveas(h,filename,'fig');
    ...
    filename = ['d:\Dropbox\Deltares\MoS-3\reporting\Garcia Report\figures\timeNspace_scanfish_turbidity'];
    disp(['saving : ',filename]);
    print('-dpng',filename);
    saveas(h,filename,'fig');
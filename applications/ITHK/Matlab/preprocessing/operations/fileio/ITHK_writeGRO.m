function ITHK_writeGRO(filename,GROdata,varargin)
%write GRO : Writes a unibest groyne file
%
%   Syntax:
%     function ITHK_writeGRO(filename, xy, Ycross, BlockPerc, Yreference, option, xyl, ray_file1, xyr, ray_file2)
% 
%   Input:
...
%
%   Example:
%     ITHK_writeGRO('test.gro', [32000,56000] , 55, 3.5, 0, 1)
%     ITHK_writeGRO('test.gro', [32,56] , 55, 3.5, 2, {[31,55]},'a1',[33,57],'a2')
%
%   See also 

...
S.PP(sens).UBmapping.ecology.juvenilefish.ShoreWidthFact = (ShoreWidth-(zminz0))./ShoreWidth;
S.PP(sens).GEmapping.ecology.juvenilefish.ShoreWidthFact = (ShoreWidth-(zminz0Rough))./ShoreWidth;  
%S.PP(sens).UBmapping.ecology.juvenilefish.ShoreWidthFact = (ShoreWidth-(zminz0>0))./ShoreWidth;
%S.PP(sens).GEmapping.ecology.juvenilefish.ShoreWidthFact = (ShoreWidth-(zminz0Rough>0))./ShoreWidth;  % if zminz0 >0, then the shoreface width decrease, then K and P of the species will descrease in a portion.
...
KMLdata      = ITHK_KMLbarplot(S.PP(sens).coast.x0_refgridRough,S.PP(sens).coast.y0_refgridRough, ...
                              (S.PP(sens).GEmapping.ecology.juvenilefish.ShoreWidthFact-PLOTscale2), ...
                              PLOToffset,sens,colour,fillalpha,PLOTscale1,popuptxt,1-PLOTscale2);
S.PP(sens).output.kml_ecology_juvenilefish = KMLdata;

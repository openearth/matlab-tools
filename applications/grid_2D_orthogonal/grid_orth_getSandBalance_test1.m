function grid_orth_getSandBalance_test1
% GRID_ORTH_GETSANDBALANCE_TEST1  This script tests the sediment budget script
...
OPT.inputtimes      = datenum(([1926 1972])',12, 31);   % starting points (in Matlab epoch time) 

...
set(p,'linewidth',2);
%l=legend('Brute force solution','Tide-averaged','Morphological factor',' " after full cycle')
l=legend('Brute force solution','Tide-averaged','flow recomputation ','Morphological factor','after full cycle');

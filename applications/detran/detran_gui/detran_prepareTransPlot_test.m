function testresult = detran_prepareTransPlot_test()
% DETRAN_PREPARETRANSPLOT_TEST  One line description goes here
%  
...
data.input{1}.total = 1000;
transType           = 'total';
fraction            = 1;
try
    [tr, trPos, trNeg] = detran_prepareTransPlot (data, transType, fraction);
    testresult = (tr==1000);
catch
    testresult = false;
end

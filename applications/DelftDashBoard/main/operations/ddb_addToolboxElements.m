...
% Delete existing elements in toolbox tab
...
handles.Model(md).GUI.elements(1).element.tabs(1).tabs.elements=gui_addElements(gcf,handles.Toolbox(tb).GUI.elements, ...
    'getFcn',@getHandles,'setFcn',@setHandles,'Parent',parent);

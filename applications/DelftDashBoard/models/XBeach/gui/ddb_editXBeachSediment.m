...
handles.GUIHandles.EditSedMorfac = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).morfac), 'Position',    [150 130 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditSedDico = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).dico), 'Position',    [320 130 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditSedDzmax = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).dzmax), 'Position',    [320 100 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditSedDryslp = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).dryslp), 'Position',    [490 130 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditSedWetslp = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).wetslp), 'Position',    [490 100 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditSedHswitch = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).hswitch), 'Position',    [490 70 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles=getHandles;
handles.Model(md).Input(ad).morfac=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditSedDico_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).dico=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditSedDzmax_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).dzmax=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditSedDryslp_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).dryslp=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditSedWetslp_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).wetslp=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditSedHswitch_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).hswitch=str2num(get(hObject,'String'));
setHandles(handles);

...
handles.GUIHandles.EditFlowC = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).C), 'Position',    [150 120 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditFlowCFL = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).CFL), 'Position',    [320 120 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditFlowEps = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).eps), 'Position',    [320 90 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditFlowHmin = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).hmin), 'Position',    [320 60 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditFlowUmin = uicontrol(gcf,'Style','edit','String',num2str(handles.Model(md).Input(ad).umin), 'Position',    [320 30 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles=getHandles;
handles.Model(md).Input(ad).C=str2num(get(hObject,'String'));
setHandles(handles);

%
function EditFlowCFL_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).CFL=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditFlowEps_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).eps=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditFlowHmin_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).hmin=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditFlowUmin_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).umin=str2num(get(hObject,'String'));
setHandles(handles);

...
handles.GUIHandles.EditWaveForcing= uicontrol(gcf,'Style','popupmenu', 'String',str,'Value',handles.Model(md).Input(ad).instat,'Position',[140 120 100 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');

handles.GUIHandles.EditWaveHrms = uicontrol(gcf,'Style','edit', 'String',num2str(handles.Model(md).Input(ad).Hrms),'Position',[360 120 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditWaveTm01 = uicontrol(gcf,'Style','edit', 'String',num2str(handles.Model(md).Input(ad).Trep),'Position',[360 90 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditWaveTlong = uicontrol(gcf,'Style','edit', 'String',num2str(handles.Model(md).Input(ad).Tlong),'Position',[360 60 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.TextOpenWaveSpectrum = uicontrol(gcf,'Style','text','String',['File : ',handles.Model(md).Input(ad).bcfile],'Position',[420 116  400 20],'HorizontalAlignment','left','Tag','UIControl');
...
handles.GUIHandles.TextOpenWaveTimeSeries = uicontrol(gcf,'Style','text','String',['File : ',handles.Model(md).Input(ad).tsfile],'Position',[420 56  400 20],'HorizontalAlignment','left','Tag','UIControl');
...
handles=getHandles;
handles.Model(md).Input(ad).instat=get(hObject,'Value');
handles=Refresh(handles); 
setHandles(handles);
...
handles=getHandles;
handles.Model(md).Input(ad).Hrms=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditWaveTm01_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).Trep=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditWaveTlong_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).Tlong=str2num(get(hObject,'String'));
setHandles(handles);
...
handles.Model(md).Input(ad).tsfile=filename;
...
handles.Model(md).Input(ad).bcfile=filename;

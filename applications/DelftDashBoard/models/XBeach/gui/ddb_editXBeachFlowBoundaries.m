...
handles.GUIHandles.EditFlowFront       = uicontrol(gcf,'Style','popupmenu', 'String',str,'Value',handles.Model(md).Input(ad).front,'Position',[140 120 100 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditFlowBack        = uicontrol(gcf,'Style','popupmenu', 'String',str,'Value',handles.Model(md).Input(ad).back,'Position',[140 90 100 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditFlowLeft        = uicontrol(gcf,'Style','popupmenu', 'String',str,'Value',handles.Model(md).Input(ad).left,'Position',[140 60 100 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditFlowRight       = uicontrol(gcf,'Style','popupmenu', 'String',str,'Value',handles.Model(md).Input(ad).right,'Position',[140 30 100 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');

handles.GUIHandles.EditFlowTideloc     = uicontrol(gcf,'Style','edit', 'String',num2str(handles.Model(md).Input(ad).tideloc),'Position',[570 120 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditFlowZs0         = uicontrol(gcf,'Style','edit', 'String',num2str(handles.Model(md).Input(ad).zs0),'Position',[500 90 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.TextOpenFlowZs0File = uicontrol(gcf,'Style','text','String',['File : ',handles.Model(md).Input(ad).zs0file],'Position',[570 26 400 20],'HorizontalAlignment','left','Tag','UIControl');
handles.GUIHandles.EditFlowPaulrevere  = uicontrol(gcf,'Style','edit', 'String',num2str(handles.Model(md).Input(ad).paulrevere),'Position',[570 90 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
handles.GUIHandles.EditFlowTidelen     = uicontrol(gcf,'Style','edit', 'String',num2str(handles.Model(md).Input(ad).tidelen),'Position',[570 60 50 20],'HorizontalAlignment','right','BackgroundColor',[1 1 1],'Tag','UIControl');
...
if handles.Model(md).Input(ad).ARC==1;   set(handles.GUIHandles.ToggleFlowARC,'Value',1); end
if handles.Model(md).Input(ad).order==1; set(handles.GUIHandles.ToggleFlowOrder,'Value',1); end
if handles.Model(md).Input(ad).carspan==1;  set(handles.GUIHandles.ToggleFlowFree,'Value',1); end
if handles.Model(md).Input(ad).epsi==1;  set(handles.GUIHandles.ToggleFlowEpsi,'Value',1); end
...
handles=getHandles;
handles.Model(md).Input(ad).front=get(hObject,'Value');
setHandles(handles);

%%
function EditFlowBack_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).back=get(hObject,'Value');
setHandles(handles);

%%
function EditFlowLeft_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).left=get(hObject,'Value');
setHandles(handles);

%%
function EditFlowRight_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).right=get(hObject,'Value');
setHandles(handles);

%%
function ToggleFlowARC_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).ARC=get(hObject,'Value');
setHandles(handles);

%%
function ToggleFlowOrder_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).order=get(hObject,'Value');
setHandles(handles);

%%
function ToggleFlowFree_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).carspan=get(hObject,'Value');
setHandles(handles);

%%
function ToggleFlowEpsi_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).epsi=get(hObject,'Value');
setHandles(handles);

%%
function EditFlowTideloc_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).tideloc=str2num(get(hObject,'String'));
handles=Refresh(handles);
setHandles(handles);
...
handles.Model(md).Input(ad).zs0file=filename;
...
handles=getHandles;
handles.Model(md).Input(ad).zs0=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditFlowPaulrevere_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).paulrevere=str2num(get(hObject,'String'));
setHandles(handles);

%%
function EditTidelen_CallBack(hObject,eventdata)
handles=getHandles;
handles.Model(md).Input(ad).tidelen=str2num(get(hObject,'String'));
setHandles(handles);

function handles=Refresh(handles)
n1=handles.Model(md).Input(ad).tideloc;

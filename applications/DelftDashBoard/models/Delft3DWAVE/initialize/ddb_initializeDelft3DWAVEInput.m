...
input.description        = {'','',''};				             
input.timestep           = 10.0;
input.onlyinputverify    = 'simulation run';
...
input.bedfriccoefjonswap= 0.067;                             

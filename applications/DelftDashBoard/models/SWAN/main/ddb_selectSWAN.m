...
callbacks={@ddb_selectToolbox,@ddb_editSWANDescription,@ddb_editSWANHydrodynamics,@ddb_editSWANGrids,@ddb_editSWANTimeFrame, ...
    @ddb_editSWANBoundaries,@ddb_editSWANObstacles,@ddb_editSWANPhysicalParameters,@ddb_editSWANNumericalParameters, ...
    @ddb_editSWANOutputCurves,@ddb_editSWANOutputParameters};

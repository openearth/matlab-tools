...
%% Download data
tmp = urlwrite(['http://waterdata.usgs.gov/nwis/dv?format=rdb&period=&begin_date=' tstart '&end_date=' tend '&referred_module=sw&cb_' Pars '=on&site_no=' SiteNo],[Dir 'nwi_usgs_data_' tstart '_' tend '.txt']);

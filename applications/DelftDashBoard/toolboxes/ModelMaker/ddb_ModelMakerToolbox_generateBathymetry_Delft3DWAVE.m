function handles=ddb_ModelMakerToolbox_generateBathymetry_Delft3DWAVE(handles,datasets)
...
handles=ddb_ModelMakerToolbox_generateBathymetry(handles,'delft3dwave',awg,'datasets',datasets,'filename',filename,'overwrite',overwrite);

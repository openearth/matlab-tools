function handles = ddb_computeHurricane(handles)
%DDB_COMPUTEHURRICANE  One line description goes here.
%
...
%%
filename2='wes_old.trk';

ok=SaveWesOldTrackFile(handles,filename2);
...
if ok==0
    system('copy wes.spw wes.spw.tmp');
    delete('wes.spw');
...
%%
function ok=SaveWesOldTrackFile(handles,filename2)
...
ddb_wlgrid('write','default.grd',X,Y);

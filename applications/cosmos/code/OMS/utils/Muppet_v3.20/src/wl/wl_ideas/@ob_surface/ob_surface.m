function Obj=ob_surface(arg1,arg2,arg3);
...
if nargin>2,
  if isfield(CmdStruct,'Type'),
    ...
    case 'bottom',
      ...
      UD.Info.ShowFrame=CmdStruct.Frame;
      UD.Info.LightMode='dull lit surf';
      UD.Info.CMode='continuous';
      UD.Info.CCMap='BrYeCr';
      set(Handles,'userdata',UD);
      refresh(Obj)
    otherwise,
      ui_message('error', ...

...
%   ADAPTED: Fixed: The UserData property of each object contains
%   the height value for each contour below it. H.R.A.Jagers 8/8/1999
%
...
for jj=IA,
  ...
  if (lev ~=minz | draw_min ),
    ...
    if (isfinite(lev)),
      H=[H;patch(xp,yp,lev,'facecolor','flat','edgecolor',edgec,'linestyle',edgestyle,'userdata',lev)]; % H.R.A.Jagers 8/8/1999: added ,'userdata',lev
    else
      H=[H;patch(xp,yp,lev,'facecolor',bg,'edgecolor',edgec,'linestyle',edgestyle,'userdata',lev)]; % H.R.A.Jagers 8/8/1999: added ,'userdata',lev
    end;
  end;
end;

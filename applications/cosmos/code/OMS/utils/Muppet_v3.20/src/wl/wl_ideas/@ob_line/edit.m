...
LineModes={'xy line','xyz line','s(x,y)z(x,y) cross','xyz(x,y) cross'};
AcceptPressed=0;
...
Fig_Height=6*XX.Margin+9*XX.But.Height+20;
...
H.Tab=tabs(fig,[XX.Margin, ...
         ...
         7*XX.But.Height+2*XX.Margin+20]);

rect(1) = 2*XX.Margin;
rect(2) = 5*XX.Margin+8*XX.But.Height+20;
rect(3) = LabelWidth;
...
rect(1) = 2*XX.Margin;
rect(2) = XX.But.Height+3*XX.Margin;
rect(3) = LabelWidth;
rect(4) = XX.Txt.Height;
...
H.Tab=add(H.Tab,'time',[H.Time H.EdTime H.NTimes H.Show H.TUnitTxt H.TUnits H.TRange H.TMin H.TMinV H.TMax H.TMaxV H.TShown H.TShownE H.FShown H.FShownE]);
...
Str=StrFrames(NClasses,'classs','classes');
...
H.Tab=add(H.Tab,'color',[H.Color H.CopyZS H.CStr H.EdCS H.NCS H.CName H.CMin H.CMinV H.CMax H.CMaxV H.EdClass H.CAuto H.NClass H.CCont H.CClass]);

% ---

rect(1) = 2*XX.Margin;
rect(2) = XX.But.Height+3*XX.Margin;
rect(3) = LabelWidth+RadioButton;
rect(4) = XX.Txt.Height;
H.TZS=uicontrol('style','text', ...
          'position',rect, ...
          'string','z data', ...
          'horizontalalignment','left', ...
          'parent',fig, ...
...
H.EdZS=uicontrol('style','pushbutton', ...
          ...
          'parent',fig, ...
          'enable','on', ...
          'callback','stackudf(gcbf,''CommandStack'',29)');
...
H.EdYS=uicontrol('style','pushbutton', ...
          ...
          'parent',fig, ...
          'enable','on', ...
          'callback','stackudf(gcbf,''CommandStack'',30)');
...
rect(3) = SmallWidth+XX.Margin+SEditWidth;
rect(4) = XX.But.Height;
H.LMod=uicontrol('style','popupmenu', ...
          'position',rect, ...
          'string',LineModes, ...
          'backgroundcolor',XX.Clr.White, ...
          'parent',fig, ...
          'enable','on', ...
          'callback','stackudf(gcbf,''CommandStack'',31)');
...
rect(3) = EditButton;
rect(4) = XX.But.Height;
H.EdZ0S=uicontrol('style','pushbutton', ...
          'position',rect, ...
          'string','edit stream', ...
          'parent',fig, ...
          'enable','on', ...
...
rect(3) = TextWidth;
rect(4) = XX.Txt.Height;
H.NZ0S=uicontrol('style','text', ...
          'position',rect, ...
          'string',StrFrames(Info.Y0Stream.NumberOfFields), ...
          'horizontalalignment','left', ...
          'parent',fig, ...
          'enable','on');
...
rect(3) = EditButton;
rect(4) = XX.But.Height;
H.EdY0S=uicontrol('style','pushbutton', ...
          'position',rect, ...
          'string','edit stream', ...
          'parent',fig, ...
          'enable','on', ...
...
rect(3) = EditButton;
rect(4) = XX.But.Height;
H.EdX0S=uicontrol('style','pushbutton', ...
          'position',rect, ...
          'string','edit stream', ...
          'parent',fig, ...
          'enable','on', ...
...
rect(3) = TextWidth;
rect(4) = XX.Txt.Height;
H.NX0S=uicontrol('style','text', ...
          'position',rect, ...
          'string',StrFrames(Info.X0Stream.NumberOfFields), ...
          'horizontalalignment','left', ...
          'parent',fig, ...
          'enable','on');
...
H.Tab=add(H.Tab,'coordinates',[H.TZS H.EdZS H.NZS H.TYS H.EdYS H.NYS H.LModT H.LMod H.TXS H.EdXS H.NXS H.TZ0S H.EdZ0S H.NZ0S H.TY0S H.EdY0S H.NY0S H.TX0S H.EdX0S H.NX0S]);

H.Tab=add(H.Tab,'general',[H.Clip H.Vis]);
...
case 'xy line',
  if ischar(Info.CStream),
    ...
    ValidStreams = (Info.X0Stream.NumberOfFields>0) & ...
     (Info.Y0Stream.NumberOfFields>0) & ...
     (Info.CStream.NumberOfFields>0);
  end;
  set([H.EdXS H.NXS H.TXS H.EdYS H.NYS H.TYS H.EdZS H.NZS H.TZS H.EdZ0S H.NZ0S H.TZ0S],'enable','off');
case 'xyz line',
  ValidStreams = (Info.XStream.NumberOfFields>0) & ...
   (Info.YStream.NumberOfFields>0) & ...
   (Info.ZStream.NumberOfFields>0) & ...
   (ischar(Info.CStream) | ...
    (Info.CStream.NumberOfFields>0));
  set([H.EdXS H.NXS H.TXS H.EdYS H.NYS H.TYS H.EdZS H.NZS H.TZS],'enable','off');
case {'s(x,y)z(x,y) cross','xyz(x,y) cross'},
  ValidStreams = (Info.X0Stream.NumberOfFields>0) & ...
   (Info.Y0Stream.NumberOfFields>0) & ...
   (Info.XStream.NumberOfFields>0) & ...
   (Info.YStream.NumberOfFields>0) & ...
   (Info.ZStream.NumberOfFields>0) & ...
   (ischar(Info.CStream) | ...
    (Info.CStream.NumberOfFields>0));
  set([H.EdZ0S H.NZ0S H.TZ0S],'enable','off');
end;
...
while ~gui_quit,
  ...
  while ~isempty(stack),
    ...
    case 21, % edit x stream
      Info.XStream=edit(Info.XStream,'x data stream');
      set(H.NXS,'string',StrFrames(Info.XStream.NumberOfFields));
    case 22, % line mode
      Info.LightMode=LModes{get(H.Light,'value')};
    case 23, % edit y0 stream
      Info.Y0Stream=edit(Info.Y0Stream,'y line stream');
      set(H.NY0S,'string',StrFrames(Info.Y0Stream.NumberOfFields));
    case 24, % clipped
      Info.Clipped=get(H.Clip,'value');
    case 25, % edit x0 stream
      Info.X0Stream=edit(Info.X0Stream,'x line stream');
      set(H.NX0S,'string',StrFrames(Info.X0Stream.NumberOfFields));
    case 26, % visible
      Info.Visible=get(H.Vis,'value');
    case 27, % name
      Info.Name=get(H.Name,'string');
    case 28, % edit x stream
      Info.Z0Stream=edit(Info.Z0Stream,'z line stream');
      set(H.NZ0S,'string',StrFrames(Info.Z0Stream.NumberOfFields));
    case 29, % edit z stream
      Info.ZStream=edit(Info.ZStream,'z data stream');
      set(H.NZS,'string',StrFrames(Info.ZStream.NumberOfFields));
    case 30, % edit y stream
      Info.YStream=edit(Info.YStream,'y data stream');
      set(H.NYS,'string',StrFrames(Info.YStream.NumberOfFields));
    case 31, % change line mode
      Info.LMode=LineModes{get(H.LMod,'value')};
      switch Info.LMode,
      case 'xy line',
        set([H.EdX0S H.NX0S H.TX0S H.EdY0S H.NY0S H.TY0S],'enable','on');
        set([H.EdXS H.NXS H.TXS H.EdYS H.NYS H.TYS H.EdZS H.NZS H.TZS H.EdZ0S H.NZ0S H.TZ0S],'enable','off');
      case 'xyz line',
        set([H.EdX0S H.NX0S H.TX0S H.EdY0S H.NY0S H.TY0S H.EdZ0S H.NZ0S H.TZ0S],'enable','on');
        set([H.EdXS H.NXS H.TXS H.EdYS H.NYS H.TYS H.EdZS H.NZS H.TZS],'enable','off');
      case {'s(x,y)z(x,y) cross','xyz(x,y) cross'},
        set([H.EdX0S H.NX0S H.TX0S H.EdY0S H.NY0S H.TY0S H.EdXS H.NXS H.TXS H.EdYS H.NYS H.TYS H.EdZS H.NZS H.TZS],'enable','on');
        set([H.EdZ0S H.NZ0S H.TZ0S],'enable','off');
      end;
    otherwise,

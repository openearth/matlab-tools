...
%REPARRAY Replicate and tile an array or subarray.
%
%   REPARRAY(A, REP, SIZ) replicates the array A or all subarrays of A.
%   REP is a vector of integers describing the number of replications to
%   perform along each dimension.  SIZ is a vector of integers
%   describing the size of each subarray.  An error will be given if A
%   can not be divided into subarrays of size SIZ.  If SIZ is omitted,
%   SIZE(A) is used.
%
...
%   Time-stamp:  2000-04-11 16:35:09

function hh = cquiver(varargin)
%CQUIVER Quiver plot with position centered arrows.
%   Indentical to QUIVER except for the position of
%   the arrows. The arrows of QUIVER start at the
%   associated X,Y position. The arrows of CQUIVER
%   are centered at the associated X,Y position.
%
%   See also QUIVER.

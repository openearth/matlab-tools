...
LModes={'unlit vectors','dull lit vectors','shiny lit vectors'};
AcceptPressed=0;
...
H.NVS=uicontrol('style','text', ...
          'position',rect, ...
          'string',StrFrames(Info.VStream.NumberOfFields), ...
          'horizontalalignment','left', ...
          'parent',fig, ...
          'enable','on');
rect(4) = XX.But.Height;
...
H.NUS=uicontrol('style','text', ...
          'position',rect, ...
          'string',StrFrames(Info.UStream.NumberOfFields), ...
          'horizontalalignment','left', ...
          'parent',fig, ...
          'enable','on');
rect(4) = XX.But.Height;
...
if (Info.XStream.NumberOfFields>0) & ...
   ...
   (Info.UStream.NumberOfFields>0) & ...
   (Info.VStream.NumberOfFields>0) & ...
   (ischar(Info.CStream) | ...
...
while ~gui_quit,
  ...
  while ~isempty(stack),
    ...
    case 29, % edit v stream
      Info.VStream=edit(Info.VStream,'v stream');
      set(H.NVS,'string',StrFrames(Info.VStream.NumberOfFields));
    case 30, % edit u stream
      Info.UStream=edit(Info.UStream,'u stream');
      set(H.NUS,'string',StrFrames(Info.UStream.NumberOfFields));
    otherwise,

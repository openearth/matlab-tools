function Obj=ob_trisurface(arg1,arg2,arg3);
% OB_SURFACE is an interface for creating a general trisurface
%
...
UD.Info.Visible=1;
UD.Info.Clipped=0;
UD.Info.LightMode='unlit surface';
UD.Info.Name='empty trisurface';
UD.Info.XStream=datastream;
UD.Info.YStream=datastream;
UD.Info.ZStream=datastream;
UD.Info.OpenUStream=datastream;
UD.Info.OpenVStream=datastream;
...
if nargin>2,
  if isfield(CmdStruct,'Type'),
    ...
    case {'waterdepth','waterlevel','sediment transport','intensity'},
      ...
      UD.Info.OpenUStream=datastream(CmdStruct.OpenU);
      UD.Info.OpenVStream=datastream(CmdStruct.OpenV);
      ...
      UD.Info.LightMode='shiny lit surf';
      UD.Info.CMode='continuous';
      switch CmdStruct.Type,
      case 'waterlevel',
        UD.Info.CCMap='bluemap';
      case 'waterdepth',
        UD.Info.CCMap='reversed bluemap';
      case 'sediment transport',
        UD.Info.CCMap='BlCrBr';
      otherwise, % 'intensity'
        UD.Info.CCMap='jet';
      end;

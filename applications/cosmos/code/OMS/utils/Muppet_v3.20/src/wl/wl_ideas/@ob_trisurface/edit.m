...
Fig_Height=15*XX.Margin+16*XX.But.Height;
...
rect(3) = EditButton;
rect(4) = XX.But.Height;
H.EdVS=uicontrol('style','pushbutton', ...
          'position',rect, ...
          'string','edit stream', ...
          'parent',fig, ...
          'enable','on', ...
...
rect(3) = TextWidth;
rect(4) = XX.Txt.Height;
H.NVS=uicontrol('style','text', ...
          'position',rect, ...
          'string',StrFrames(Info.OpenVStream.NumberOfFields), ...
          'horizontalalignment','left', ...
          'parent',fig, ...
          'enable','on');
rect(4) = XX.But.Height;
...
rect(3) = EditButton;
rect(4) = XX.But.Height;
H.EdUS=uicontrol('style','pushbutton', ...
          'position',rect, ...
          'string','edit stream', ...
          'parent',fig, ...
          'enable','on', ...
...
rect(3) = TextWidth;
rect(4) = XX.Txt.Height;
H.NUS=uicontrol('style','text', ...
          'position',rect, ...
          'string',StrFrames(Info.OpenUStream.NumberOfFields), ...
          'horizontalalignment','left', ...
          'parent',fig, ...
          'enable','on');
rect(4) = XX.But.Height;
...
if (Info.XStream.NumberOfFields>0) & ...
   ...
   (Info.OpenUStream.NumberOfFields>0) & ...
   (Info.OpenVStream.NumberOfFields>0) & ...
   (ischar(Info.CStream) | ...
...
while ~gui_quit,
  ...
  while ~isempty(stack),
    ...
    case 29, % edit open v stream
      Info.OpenVStream=edit(Info.OpenVStream,'open v stream');
      set(H.NVS,'string',StrFrames(Info.OpenVStream.NumberOfFields));
    case 30, % edit open u stream
      Info.OpenUStream=edit(Info.OpenUStream,'open u stream');
      set(H.NUS,'string',StrFrames(Info.OpenUStream.NumberOfFields));
    otherwise,

...
%
%   POLYGEOM(X,Y) returns geometry of the polygon 
%   specified by vertices in vectors X and Y.
%
%   POLYGEOM returns area, centroid location, perimeter
%   and area moments of inertia for a planar polygon.
%   GEOM = [ area   x_cen  y_cen  perimeter ]
%   INER = [ Ixx    Iyy    Ixy    Iuu    Ivv    Iuv ]
%     u,v are centroidal axes respectively parallel to x,y axes.

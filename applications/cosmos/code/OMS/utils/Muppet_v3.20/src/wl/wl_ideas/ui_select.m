function sdim=ui_select(nsel,dimname,enab),
% UI_SELECT displays a selection window
%            SELECTION=UI_SELECT(NSELECT,ITEMNAMES,ENABLED)
...
for dim=1:ndim,
  ...
  rb(dim)=uicontrol('style',rbstyle, ...
            ...
            'parent',fig, ...
            'string',Str, ...
            'callback',['set(gcbf,''userdata'',',num2str(dim),')'], ...

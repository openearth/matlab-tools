function t = gui_str(x,f)
%GUI_STR Number to string conversion for editing.
%        T = GUI_STR(X) converts the scalar number  X into a string
...
%
%        T=GUI_STR(X,'vec') converts a vector of numbers into

...
if strcmp(lower(FigureProperties.Renderer),'opengl');
    xback=xmin;
    xmin=xmin-xback;
    xmax=xmax-xback;
else
...
if xtick>0.0
    ...
    set(gca,'xtick',xticks,'xticklabel',xlabls,'FontSize',SubplotProperties.XLabelFontSize*FigureProperties.FontRed);
else
    tick(gca,'x','none');
end
...
%            set(datetxt(i),'FontSize',8*FigureProperties.FontRed,'HorizontalAlignment','center');
            set(datetxt(i),'FontSize',SubplotProperties.AxesFontSize*FigureProperties.FontRed,'HorizontalAlignment','center');
        end
    end
end
    ...
    case{'linear'}
        if SubplotProperties.YTick>0
            ...
            if SubplotProperties.DecimY>=0
                ...
                set(gca,'yticklabel',ylabls,'FontSize',SubplotProperties.YLabelFontSize*FigureProperties.FontRed);

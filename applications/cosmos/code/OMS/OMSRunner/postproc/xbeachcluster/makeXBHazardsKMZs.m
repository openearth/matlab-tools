...
if n>0
    ...
    [x0,y0]=ConvertCoordinates(x0,y0,'CS1.name',Model.CoordinateSystem,'CS1.type','xy','CS2.name','WGS 84','CS2.type','geo');
    [x1,y1]=ConvertCoordinates(x1,y1,'CS1.name',Model.CoordinateSystem,'CS1.type','xy','CS2.name','WGS 84','CS2.type','geo');
...
%        columnKML([col{j} '.' Model.Name],x0,y0,columns.(col{j}),'colormap',jet,'levels',clim,'kmz',1,'radius',15,'zfac',zfac,'directory',figdir,'url',Model.figureURL,'screenoverlay',[figdir col{j} '.colorbar.png'],'lookat',lookat);
    ...
    [original_shoreline_x,original_shoreline_y]=ConvertCoordinates(original_shoreline_x,original_shoreline_y,'CS1.name',Model.CoordinateSystem,'CS1.type','xy','CS2.name','WGS 84','CS2.type','geo');
    [final_shoreline_x,final_shoreline_y]=ConvertCoordinates(final_shoreline_x,final_shoreline_y,'CS1.name',Model.CoordinateSystem,'CS1.type','xy','CS2.name','WGS 84','CS2.type','geo');
    [original_backbeach_x,original_backbeach_y]=ConvertCoordinates(original_backbeach_x,original_backbeach_y,'CS1.name',Model.CoordinateSystem,'CS1.type','xy','CS2.name','WGS 84','CS2.type','geo');
    [final_backbeach_x,final_backbeach_y]=ConvertCoordinates(final_backbeach_x,final_backbeach_y,'CS1.name',Model.CoordinateSystem,'CS1.type','xy','CS2.name','WGS 84','CS2.type','geo');
    [max_runup_x,max_runup_y]=ConvertCoordinates(max_runup_x,max_runup_y,'CS1.name',Model.CoordinateSystem,'CS1.type','xy','CS2.name','WGS 84','CS2.type','geo');

...
%% first remove field OPT.datum_trans.code if it is empty
...
if isempty(OPT.datum_trans_from_WGS84.code)
...
if OPT.CS1.geoRefSys.code == OPT.CS2.geoRefSys.code
    ...
    if ~isempty(ind)
        ...
        OPT.datum_trans.ellips1       = OPT.CS1.ellips;
        OPT.datum_trans.ellips2       = OPT.CS2.ellips;
    else
        ...
        OPT.datum_trans_to_WGS84.ellips1     = OPT.CS1.ellips;
        OPT.datum_trans_to_WGS84.ellips2     = WGS84.ellips;

        % WGS 84 to geogcrs_code2
        [ OPT,ind,direction ] = findTransOptions(OPT,STD,4326,OPT.CS2.geoRefSys.code,'datum_trans_from_WGS84');
        if isempty(ind), error('no transformation available...'), end
        ...
        OPT.datum_trans_from_WGS84.ellips1     = WGS84.ellips;
        OPT.datum_trans_from_WGS84.ellips2     = OPT.CS2.ellips;
    end
end
end
...
% if no method has been defined by user, use the method with the highest 
% code if more methods are found (assuming this value is newest method)
else
    if length(ind_alt)>1

...
nc_varput(OPT.ncfile, 'z', MCresult.Output.z, start_3d(1:2), count_3d(1:2));
nc_varput(OPT.ncfile, 'P_f', MCresult.Output.P_f, start_3d(1), count_3d(1));
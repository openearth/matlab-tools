...
stochast_new = struct(...
    ...
    'S'... % example stochastic variable "S" (Sollicitation or Load)
    },...
    'Distr', {
    ...
    'Params', {
    {9 2}... % mu and sigma (of R)
    {6 3}... % mu and sigma (of S)
    },...
    'propertyName', {
    true... % add propertyname (of R) in z-function call
    true... % add propertyname (of S) in z-function call
    } ...
    );

...
%<<<<<<< .mine
            % you do this.ApproximateUsingARS    = false;
...
%<<<<<<< .mine
            % this.BetaValues and this.ZValues are empthy because of reset
            % and we need to start again from the origin
...
%                     xtest=[-50:0.1:50];
%                     plot(xtest,polyval(this.Fit,xtest))
%                     hold on;
%                     plot(xtest,0,'r*')
%                     hold on;
%                     plot(this.Roots,0,'*k')
%                     hold on;
%                     count=count+1;
%                     name_fig = ['linesearch_',num2str(count),'.png'];
%                     saveas(gca,name_fig)

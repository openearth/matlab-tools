        ...
        function plot(this, figureHandle, evaluationApproachesZero)
            ...
            axis(s,'equal')
             ...
             uitable( ...
                ...
                'Data', [], ...
                'ColumnName', { 'Evaluation is exact and approaches zero', 'Evaluation is not exact and approaches zero', 'Number exact Evaluations'},...
            ...
            data = { ...
                sum(this.EvaluationIsExact & evaluationApproachesZero) sum(~this.EvaluationIsExact & evaluationApproachesZero) this.NumberExactEvaluations ; ...

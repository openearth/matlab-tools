...
while b==1
    ...
    if b~=1
        delete(findobj(fig,'Color',[0 0 1],'Marker','o'));
        return
    end
    ...
    [xClick, yClick,b]=ginput(1);
    if b~=1
        delete(hCp1);delete(findobj(fig,'Color',[0 0 1],'Marker','o'));
        return
    end
    ...
    [dum,dum,b2]=ginput(1);
    delete(hCp1); delete(hCp2);delete(findobj(fig,'Color',[0 0 1],'Marker','o'));
    if b2~=1;

...
ncwrite(ncfile,'NetNode_x',X(:));
ncwrite(ncfile,'NetNode_y',Y(:));
ncwrite(ncfile,'NetNode_z',Z(:));
ncwriteatt(ncfile,'NetNode_x','actual_range',[min(X(:)) max(X(:))]);
ncwriteatt(ncfile,'NetNode_y','actual_range',[min(Y(:)) max(Y(:))]);
ncwriteatt(ncfile,'NetNode_z','actual_range',[min(Z(:)) max(Z(:))]);

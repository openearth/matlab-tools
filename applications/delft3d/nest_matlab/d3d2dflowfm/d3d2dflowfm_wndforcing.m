...
if ~isempty (filwnd)
    ...
    %
    % General Comments
    SERIES.Comments{1} = '* COLUMN1=Time (minutes since ITDATE?';
    SERIES.Comments{2} = '* COLUMN2=Windspeed (m/s)';
    SERIES.Comments{3} = '* COLUMN3=Winddirection (deg, nautical convention)';

nesthd_w64  d:\open_earth_test\matlab\applications\delft3d\nest_matlab\simona\tidal_flume_triwaq\triwaq_coarse\flume_hd1.ini 
nesthd_w64  d:\open_earth_test\matlab\applications\delft3d\nest_matlab\simona\tidal_flume_triwaq\triwaq_coarse\flume_hd2.ini 

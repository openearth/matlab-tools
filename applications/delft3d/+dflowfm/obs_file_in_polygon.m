...
%    Can either be a string containing the location of the *_map.nc file, or a
%    structure generated by dflowfm.readNet (note that only *_map.nc files
%    are supported, as grid files (*_net.nc) do not contain flownode locations)
%
%  <Polygon *.pol or landboundary *.ldb file>
%    Can either be a string containing the location of a *.pol or *.ldb
%    file, or an [Mx2] or [2xM] matrix (generated by e.g. the function 
%    landboundary, LDBTool or manually)
%

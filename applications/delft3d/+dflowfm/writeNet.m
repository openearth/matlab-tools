...
%
%  dflowfm.writeNet(ncfile,x,y,<Links>,<z>,<keyword,value>) 
%
...
%  FM_mesh.cor.z = FM_mesh.cor.x - 1; (**)
%  dflowfm.writeNet('New_D_Flow_FM_net.nc',FM_mesh.cor.x,FM_mesh.cor.y,FM_mesh.cor.Link,FM_mesh.cor.z);
%

...
!
    ...
    integer    , intent(in)     :: iflagcriteriumvol    !< Flag to control the criterium for free-flowing (onvolkomen) and submerged (volkomen) conditions:
                                                        !! 1: Villemonte different than Tabellenboek (original)
                                                        !! 2: Both Villemonte and Tabellenboek with the criterium of Tabellenboek
    integer    , intent(in)     :: iflaglossvol         !< Flag to control the energy losses under free-flowing conditions:
...
!
    ...
    elseif (iflagweir == 25) then     !! Villemonte
       ...
       elseif (testfixedweirs == 2) then
           !no vegetation 
           vil1 = 1.0d0 + ddive * (1.0d0-exp(-rmpben/vilcd(2)))
           vil2 = 1.0d0 + ddive
           pref=VillemonteCD3*27.0d0/(4.0d0*cd0**2)/(1.0d0/vil1-1.0d0/vil2)**2
       endif
    ...
    !
    if (iflaglossvol == 1 ) then
        dtevol = wsbov - wsben - dtefri
    elseif (iflaglossvol == 2) then
        dtevol = eweir - ewben - dtefri
    endif
    ...
    elseif (iflagcriteriumvol == 2) then

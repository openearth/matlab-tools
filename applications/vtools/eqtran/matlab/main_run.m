...
taub      = 0;
z0cur     = 0.01; %currents
z0rouk    = 0.001; %wave. chezy=sqrt(ag)/0.41*log(h1/exp(1)/z0rouk)
dg        = 0;
dgsd      = 0;
sandfrac  = 0;
...
[...
    ...
    numstrpar,dllfunc,dllhandle,intpar,strpar,lsecfl,drho,tetacr,dstar,taucr0,chezy...
    ]=D3D_erosed(...
...
[qbk]=sediment_transport_V(rhosol,rhowat,ag,iform,hidexp,rmu,vicmol,realpar(4),chezy,h1,di50,acal,cc,thcr);
if abs(sbcu-qbk*rhosol)>1e-8
    warning('Difference in sediment transport')
end

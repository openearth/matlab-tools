...
%% ECT
 ...
 [eigen_all,elliptic,A,D_f,B_f,cp,Ribb,out,pmm,...
  ...
  ]=ECT(flg,'gsd',gsd,'nodeState',nodeState,'sedTrans',sedTrans,'hiding',hiding,'ad',u_b,'secflow',[I,1,beta_c,NaN,Dh],'twoD',NaN,'kappa',kappa,'E_param',E_param,'vp_param',vp_param,'gsk_param',gsk_param,'diff_mom',nu_mom,'diff_hir',diff_hir,'cnt',cnt,'MorFac',mor_fac,'advection',advection);

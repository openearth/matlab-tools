...
[lab,str_var,str_un,str_diff,str_background,str_std,str_diff_back,str_fil,str_rel,str_perc,str_dom]=labels4all(in_p.data_varname,1,lan);
figure
...
for kp=1:np
    ...
    switch plot_variable
        case 'mag'
            in_p.val=in_p.data_mag;
            in_p.varname=in_p.data_varname;
            in_p.title_str='';
            in_p.do_title=0;
        case 'dir'
            in_p.val=in_p.data_dir;
            in_p.varname='dir';
            in_p.title_str=labels4all(in_p.data_varname,1,lan);
            in_p.do_title=1;
    end

    %% time series

    in_p.s=in_p.data_tim;

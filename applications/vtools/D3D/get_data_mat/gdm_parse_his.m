...
flg_loc=isfield_default(flg_loc,'do_all_sim',0);  %deprecated  
flg_loc=isfield_default(flg_loc,'do_all_s',flg_loc.do_all_sim);  
flg_loc=isfield_default(flg_loc,'do_s',0);   %deprecated
flg_loc=isfield_default(flg_loc,'do_diff_s',flg_loc.do_s);   %deprecated
flg_loc=isfield_default(flg_loc,'do_diff',0);   %deprecated

...
%
%$Revision: 19910 $
%$Date: 2024-11-25 08:42:34 +0100 (Mon, 25 Nov 2024) $
%$Author: chavarri $
%$Id: plot_1D_01.m 19910 2024-11-25 07:42:34Z chavarri $
...
%We need the number of layers. We are assuming same number of layers for
%all simulations. I have never plotted something that needs it yet.
...
%                 end
            ...
            %% xvt
            if flg_loc.do_xvt && ~multi_dim
               plot_xvt(fid_log,flg_loc,rkmv.rkm_cen,tim_dtime_p,lab_str,data_xvt,data_xvt0,simdef,sb_pol,pol_name,var_str_save,tag,runid,in_p.all_struct,tag_fig,tag_serie,flg_loc.var_idx{kvar})
            end

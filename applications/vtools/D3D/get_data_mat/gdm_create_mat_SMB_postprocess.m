...
function gdm_create_mat_SMB_postprocess(fid_log,flg_loc,simdef)
    ...
    for krkmv=1:nrkmv %rkm polygons
        ...
        for kt=kt_v %time
            ...
            for kvar=1:nvar %variable
                ...
                switch flg_loc.var{kvar}
                    ...
                    otherwise
                        if flg_loc.do_val_B_mor(kvar) %multiply value by morphodynamic width
                            ...
                            val_mean_weighted=val.*data_ba_mor.data.val_sum_length;
                        elseif flg_loc.do_val_B(kvar) %multiply value per width
                            ...
                            val_mean_weighted=val.*data_ba.data.val_sum_length;
                        else
                            continue
                        end
                end
                ...
                %% data
                data=v2struct(val_mean,val_mean_weighted); %#ok

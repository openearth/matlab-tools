...
fprintf(fid,'FILENAME        =%s      \n',relative_path(simdef.file.ini_vx,simdef.D3D.dire_sim));
...
fprintf(fid,'FILENAME        =%s      \n',relative_path(simdef.file.ini_vy,simdef.D3D.dire_sim));
fprintf(fid,'FILETYPE        =7               \n');
fprintf(fid,'METHOD          =6               \n');
fprintf(fid,'AVERAGINGTYPE   =2               \n');
fprintf(fid,'OPERAND         =O               \n');
...
% fprintf(fid,'FILENAME        =%s      \n',simdef.file.etaw);
fprintf(fid,'FILENAME        =%s      \n',relative_path(simdef.file.etaw,simdef.D3D.dire_sim));
fprintf(fid,'FILETYPE        =7               \n');
fprintf(fid,'METHOD          =6               \n');
fprintf(fid,'AVERAGINGTYPE   =2               \n');
fprintf(fid,'OPERAND         =O               \n');
...
% fprintf(fid,'FILENAME        =%s      \n',simdef.mdf.dep); %this should be a full path?
fprintf(fid,'FILENAME        =%s      \n',relative_path(simdef.file.dep,simdef.D3D.dire_sim));
fprintf(fid,'FILETYPE        =7               \n');
fprintf(fid,'METHOD          =6               \n');
fprintf(fid,'AVERAGINGTYPE   =2               \n');
fprintf(fid,'OPERAND         =O               \n');

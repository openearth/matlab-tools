...
function NC_create_1D_grid(filename)
...
network_branch_long_name=cell2char(network_branch_id,strLengthLongNames); %!ATTENTION change of type
network_node_id=cell2char(network_node_id,strLengthLongNames); %!ATTENTION change of type
network_node_long_name=cell2char(network_node_id,strLengthLongNames); %!ATTENTION change of type
...
netcdf.putAtt(ncid, netcdf.getConstant('NC_GLOBAL'), 'history', ['Created on ' datestr(now, 'yyyy-mm-ddTHH:MM:SS')]);

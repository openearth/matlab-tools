...
switch varname
    ...
    case {'ShieldsD'}
        data_var=gdm_read_data_map_ShieldsD(fdir_mat,fpath_map,varname,'tim',time_dnum,'var_idx',var_idx,'idx_branch',idx_branch,'branch',branch,'layer',layer,'tol_t',tol_t); 
    case {'dzetadt'}

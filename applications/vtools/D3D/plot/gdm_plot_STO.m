...
tim_dtime_plot=time_dtime;
time_dnum_plot=time_dnum;
...
for kxlim=1:nxlim
    fname_noext=fullfile(fdir_fig_loc,sprintf('%s_all_%s_%s_%s_%s_kxlim_%d',tag,runid,datestr(time_dnum_plot(kt),'yyyymmdd_HHMMSS'),statis,sb_pol{ksb},kxlim));

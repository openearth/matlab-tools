...
if ~isempty(var_idx)
    data_frac=gdm_read_data_map_Fak(fdir_mat,fpath_map,'LYRFRAC','tim',time_dnum,'branch',branch,'layer',[],'var_idx',var_idx,'tol_t',tol_t); %sum of the fractions in <var_idx>

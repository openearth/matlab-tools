...
simdef.D3D.dire_sim=fullfile('p:\i1000561-riverlab-2021\08_bars_chaos\06_simulations\02_runs\',simdef.runid.name);
...
simdef.grd.L=               5000; %domain length [m] [10,100]
simdef.grd.B=               80; %width [m]; [0.01,0.05,0.1,0.2,1.0,10]
simdef.grd.dx=              10; %dx [m]; [0.01,0.05,0.1,0.2,1.0,10]
...
simdef.mdf.Vicouv=          0.1; %horizontal eddy viscosity [m^2/s] [double(1,1)] e.g. [5]
simdef.mdf.Dicouv=          0.1; %horizontal eddy diffusivity [m^2/s] [double(1,1)] e.g. [5]
...
simdef.mor.HiranoDiffusion= 0; %Diffusion coefficient applied to Mak to regularize the active layer model [m^2/s] [double(1,1)]. Default = 1 m^2/s
...
%% Sediment Transport and display

D3D_display_simdef(simdef)
